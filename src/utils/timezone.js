...
export const toUAETime = (utcDate, options = {}) => {
  ...
  switch (format) {
    case 'date':
      // DD/MM/YYYY format
      result = date.toLocaleDateString('en-GB', { ...dateOptions, timeZone: UAE_TIMEZONE });
      break;

    case 'long':
      // "January 15, 2025" format
      result = date.toLocaleDateString('en-AE', { ...dateOptionsLong, timeZone: UAE_TIMEZONE });
      break;

    case 'time':
      // "02:30 PM" format
      result = date.toLocaleTimeString('en-AE', { ...timeOptions, timeZone: UAE_TIMEZONE });
      break;
