...
export const createInvoice = () => ({
  ...
  notes: "",
  terms:
    "Kindly check the product before unloading. If any complaint arises, contact us immediately.\nNo items will be returned without prior authorisation",
  ...
  commissionPercentage: 10.0, // Phase 5: Commission rate as percentage (default 10%)
