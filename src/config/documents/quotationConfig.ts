// ═══════════════════════════════════════════════════════════════
// QUOTATION CONFIG - Simplified (No Locking, No Stock Allocation)
// For customer quotes/proposals before conversion to invoice
// ═══════════════════════════════════════════════════════════════

import { DocumentFormConfig } from './types';

export const quotationConfig: DocumentFormConfig = {
  configVersion: 1,
  ...
  features: {
    ...
    // Header
    enableDueDate: true, // Used as "Valid Until" date
    ...
    // Special (No locking or stock allocation for quotations)
    enableLocking: false,
  ...
  headerFields: [
    ...
    {
      key: 'dueDate',
      label: 'Valid Until', // Different label for quotations
      type: 'date',
      required: false,
      visible: true,
      editable: true,
    ...
    },
    {
      ...
      visible: true,
      editable: true,
      placeholder: 'Ex-warehouse, FOB, CIF, etc.',
    },
    {
      key: 'emirate',
    ...
    },
    {
      ...
      visible: true,
      editable: true,
      placeholder: 'Customer Reference, RFQ Number, etc.',
    },
  ],

  // Line Item Columns Configuration (Same as invoice)
  lineItemColumns: [
    {
      key: 'productName',
      label: 'Product',
  ...
  // Charge Types Configuration (Same as invoice)
  chargeTypes: [
    {
      key: 'packing',
  ...
  // Slots (No special slots for quotation)
  slots: {},
