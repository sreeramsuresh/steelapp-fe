...
describe("payablesService", () => {
  ...
  describe("Invoice Management", () => {
    ...
    describe("addInvoicePayment", () => {
      test("should record invoice payment", async () => {
        ...
        expect(result.id).toBe(1);
        expect(apiClient.post).toHaveBeenCalledWith("/payables/invoices/1/payments", expect.any(Object));
      });
    ...
    describe("voidInvoicePayment", () => {
      test("should void invoice payment", async () => {
        ...
        expect(result.id).toBe(1);
        expect(apiClient.post).toHaveBeenCalledWith("/payables/invoices/1/payments/p1/void", {
  ...
  describe("PO Management", () => {
    ...
    describe("addPOPayment", () => {
      test("should record PO payment", async () => {
        ...
        expect(result.id).toBe(1);
        expect(apiClient.post).toHaveBeenCalledWith("/payables/pos/1/payments", expect.any(Object));
      });
  ...
  describe("Edge Cases", () => {
    ...
    test("should handle decimal amounts", async () => {
      ...
      expect(result.invoice_amount).toBe(10000.5);
    });
