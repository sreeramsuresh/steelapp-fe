...
describe("operatingExpenseService", () => {
  ...
  describe("getExpenses", () => {
    test("should fetch all operating expenses with pagination", async () => {
      ...
      sinon.assert.calledWith(apiClient.get, "/operating-expenses", );
    });

    test("should filter by expense type", async () => {
      sinon.stub(apiClient, 'get').resolves({ data: [], pagination: {} });
  ...
  describe("getExpenseById", () => {
    test("should fetch single expense with details", async () => {
      ...
      sinon.assert.calledWith(apiClient.get, "/operating-expenses/1");
    });
  });
  ...
  describe("createExpense", () => {
    test("should create new operating expense", async () => {
      ...
      assert.ok(result.id);
      sinon.assert.calledWith(apiClient.post, "/operating-expenses", payload);
    });
  });
  ...
  describe("updateExpense", () => {
    test("should update operating expense", async () => {
      ...
      assert.ok(result.amount);
      sinon.assert.calledWith(apiClient.put, "/operating-expenses/1", payload);
    });
  });
  ...
  describe("deleteExpense", () => {
    test("should delete expense", async () => {
      ...
      sinon.assert.calledWith(apiClient.delete, "/operating-expenses/1");
    });
  });
  ...
  describe("approveExpense", () => {
    test("should approve operating expense", async () => {
      ...
      sinon.assert.calledWith(apiClient.put, "/operating-expenses/1/approve", );
    });
  });
