...
describe("vatAmendmentService", () => {
  ...
  describe("getAll", () => {
    it("should fetch all VAT amendments with pagination", async () => {
      apiClient.get.mockResolvedValue({
        data: [{ id: 1, amendmentNumber: "VA001", status: "draft" }],
    ...
    it("should handle array response format", async () => {
      apiClient.get.mockResolvedValue([{ id: 1, amendmentNumber: "VA001" }]);
  ...
  describe("getPending", () => {
    it("should fetch pending amendments", async () => {
      apiClient.get.mockResolvedValue([{ id: 1, amendmentNumber: "VA001", status: "pending_review" }]);
