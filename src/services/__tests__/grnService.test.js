...
describe("grnService", () => {
  ...
  describe("Advanced Tracking via Service Methods", () => {
    ...
    it("should prevent exceeding ordered quantity", async () => {
      vi.spyOn(apiClient, "post").mockRejectedValue(new Error("Received quantity exceeds ordered quantity"));
  ...
  describe("approve()", () => {
    ...
    it("should prevent approving GRN with rejections", async () => {
      vi.spyOn(apiClient, "post").mockRejectedValue(new Error("Cannot approve GRN with rejected items"));
  ...
  describe("cancel()", () => {
    ...
    it("should prevent cancelling approved GRN", async () => {
      vi.spyOn(apiClient, "post").mockRejectedValue(new Error("Cannot cancel approved GRN"));
  ...
  describe("markBilled()", () => {
    ...
    it("should enforce 3-way match logic", async () => {
      vi.spyOn(apiClient, "post").mockRejectedValue(new Error("PO, GRN, and Bill quantities do not match"));
  ...
  describe("Error Handling", () => {
    ...
    it("should handle network errors in approve", async () => {
      vi.spyOn(apiClient, "post").mockRejectedValue(new Error("Service unavailable"));
