...
describe("dashboardService", () => {
  ...
  describe("getMainDashboard", () => {
    ...
    test("should handle aggregation errors gracefully", async () => {
      analyticsService.getDashboardData.mockRejectedValueOnce(new Error("API Error"));
  ...
  describe("Error Recovery", () => {
    test("should provide default values on API failures", async () => {
      analyticsService.getDashboardData.mockRejectedValueOnce(new Error("Service unavailable"));
