...
describe("invoiceService", () => {
  ...
  describe("Error Handling", () => {
    ...
    it("should handle errors in issueInvoice", async () => {
      vi.spyOn(apiClient, "post").mockRejectedValue(new Error("Cannot issue locked invoice"));
    ...
    it("should handle errors in updateInvoiceStatus", async () => {
      vi.spyOn(apiClient, "patch").mockRejectedValue(new Error("Invalid status transition"));
