...
describe("exchangeRateService", () => {
  ...
  describe("Currency Conversion", () => {
    ...
    test("should handle currency conversion error", async () => {
      ...
      await expect(exchangeRateService.convertCurrency({ amount: 100, from: "XXX", to: "YYY" })).rejects.toThrow(
        "Invalid currency"
      );
    });
  });
