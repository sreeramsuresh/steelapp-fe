...
const CACHE_KEYS = {
  STOCK_LEVELS_SUMMARY: 'stock_levels_summary_cache',
  STOCK_LEVELS_LIST: 'stock_levels_list_cache',
};
...
const setCachedData = (key, data) => {
  try {
    ...
    console.warn('Stock levels cache write failed:', e);
  }
};
...
/**
 * Clear all stock levels cache
 */
const clearStockLevelsCache = () => {
  try {
    localStorage.removeItem(CACHE_KEYS.STOCK_LEVELS_SUMMARY);
    localStorage.removeItem(CACHE_KEYS.STOCK_LEVELS_LIST);
  } catch (e) {
    console.warn('Failed to clear stock levels cache:', e);
  }
};

// Export cache utilities for use in components
export {
  CACHE_KEYS as STOCK_CACHE_KEYS,
  CACHE_TTL_MS as STOCK_CACHE_TTL_MS,
  getCachedData as getStockCachedData,
  setCachedData as setStockCachedData,
  isCacheFresh as isStockCacheFresh,
  clearStockLevelsCache,
};
...
export const MOVEMENT_TYPES = {
  ...
  TRANSFER_OUT: { value: 'TRANSFER_OUT', label: 'Transfer Out', color: 'orange' },
...
export const RESERVATION_STATUSES = {
  ...
  PARTIALLY_FULFILLED: { value: 'PARTIALLY_FULFILLED', label: 'Partial', color: 'warning' },
