          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-700 leading-relaxed">
                At Ultimate Steels, we are committed to delivering high-quality
                steel products and solutions that power industries,
                infrastructure, and innovation. With a strong foundation in
                expertise and excellence, we cater to diverse sectors, including
              ...
              <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-8 rounded-3xl border border-blue-100">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    { name: "GCC Region", status: "Expanding", color: "pink" },
                  ].map((area, index) => (
                    <div
                      key={index}
