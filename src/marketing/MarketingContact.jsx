        ...
        <section className="py-20 bg-gradient-to-r from-slate-900 via-gray-900 to-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <button type="button" className="px-10 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold text-lg rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
                Request Quote
              </button>
              {/* eslint-disable-next-line local-rules/no-dead-button */}
              <button type="button" className="px-10 py-4 border-2 border-white text-white font-bold text-lg rounded-lg hover:bg-white hover:text-gray-900 transition-all duration-300 transform hover:scale-105"
              >
                Schedule Visit
              </button>
              {/* eslint-disable-next-line local-rules/no-dead-button */}
              <button type="button" className="px-10 py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-bold text-lg rounded-lg hover:from-green-700 hover:to-emerald-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
                Call Now
              </button>
            </div>
