    ...
    <MarketingLayout>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="relative bg-gradient-to-r from-slate-900 via-gray-900 to-slate-800 text-white overflow-hidden">
          ...
          Your premier supplier of high-quality steel building materials in
          Ajman and across the UAE
            </p>
            <Link
              to="/login"
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          <section className="mb-20">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                Welcome to{' '}
                  <span className="font-bold text-blue-600">Ultimate Steels</span>
                , your premier supplier of high-quality steel building materials
                in Ajman and across the UAE. With years of expertise in the
                industry, we have built a reputation for delivering durable,
                reliable, and cost-effective steel solutions tailored to meet
                the needs of construction, infrastructure, and industrial
                projects.
                </p>

                <p className="text-lg text-gray-700 leading-relaxed">
                At Ultimate Steels, we take pride in being a trusted name in the
                steel supply sector. We specialize in providing top-grade steel
                products, ensuring strength, flexibility, and longevity for
                projects of all sizes. Whether you are working on commercial,
                residential, or industrial developments, our comprehensive range
                of steel materials is designed to meet international standards
          ...
          <section className="mb-20">
            <div className="text-center mb-12">
              ...
              We offer a wide range of steel building materials, ensuring
              strength, flexibility, and longevity for projects of all sizes.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-slate-50 to-gray-50 rounded-xl">
                <p className="text-gray-700 text-center">
                  <span className="font-bold">Expert Team:</span> Our team of
                experts ensures that every product is sourced and manufactured
                with the highest level of precision, meeting the demands of
                modern construction and engineering projects.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-20">
            <div className="bg-gradient-to-r from-slate-900 via-gray-900 to-slate-800 rounded-2xl p-12 text-white">
              ...
              <div className="mt-12 text-center">
                <button className="px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105 shadow-lg mr-4">
                Get a Quote
                </button>
