            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  ...
                  , your premier supplier of high-quality steel building
                  materials in Ajman and across the UAE. With years of expertise
                  in the industry, we have built a reputation for delivering
                  durable, reliable, and cost-effective steel solutions tailored
                  to meet the needs of construction, infrastructure, and
                  industrial projects.
                </p>

                <p className="text-lg text-gray-700 leading-relaxed">
                  At Ultimate Steels, we take pride in being a trusted name in
                  the steel supply sector. We specialize in providing top-grade
                  steel products, ensuring strength, flexibility, and longevity
                  for projects of all sizes. Whether you are working on
                  commercial, residential, or industrial developments, our
                  comprehensive range of steel materials is designed to meet
                  international standards and project-specific requirements.
                </p>
