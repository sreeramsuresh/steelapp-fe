...
export default function CustomerCreditManagement() {
  ...
  const handleSelectCustomer = async (customer) => {
    try {
      ...
      setAgingData(aging);
      setNewCreditLimit(
        (details?.creditLimit || details?.credit_limit || 0).toString(),
      );
      setError(null);
    } catch (err) {
      const errorMsg =
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            {/* High Risk Customers */}
            <div
              className={`rounded-lg shadow mb-6 ${isDarkMode ? "bg-gray-800" : "bg-white"}`}
            >
              <div
          ...
          <div className="lg:col-span-1">
            {selectedCustomer && creditDetails ? (
              <div
                className={`rounded-lg shadow p-6 sticky top-6 ${isDarkMode ? "bg-gray-800" : "bg-white"}`}
              >
                <h2
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex justify-between items-center">
                    ...
                    <span
                      className={`px-3 py-1 rounded font-bold ${getCreditGradeColor(creditDetails.creditGrade)}`}
                    >
                    ...
                    >
                      ...
                      {Math.max(
                        ...
                        creditDetails.creditLimit -
                          creditDetails.outstandingAmount,
                      )?.toFixed(2)}
                    </span>
                  </div>
                  <div
                ...
                {agingData && (
                  <div
                    className={`border-t pt-4 mb-6 ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}
                  >
                    <h3
                    ...
                    <div
                      className={`space-y-2 text-sm ${isDarkMode ? "text-gray-300" : "text-gray-900"}`}
                    >
                      <div className="flex justify-between">
                        <span>Current</span>
                        <span className="font-semibold">
                          ${agingData.currentAmount?.toFixed(2)}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span>1-30 days</span>
                        <span className="font-semibold">
                          ${agingData.days1_30?.toFixed(2)}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span>31-60 days</span>
                        <span className="font-semibold">
                          ${agingData.days31_60?.toFixed(2)}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span>61-90 days</span>
                        <span className="font-semibold">
                          ${agingData.days61_90?.toFixed(2)}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span>90+ days</span>
                        <span className="font-semibold text-red-600">
                          ${agingData.days90Plus?.toFixed(2)}
                        </span>
                      </div>
                    </div>
                  </div>
