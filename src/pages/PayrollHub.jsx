import { Layers, PlayCircle, Settings } from "lucide-react";
...
const tabs = [
  { id: "runs", label: "Payroll Runs", icon: PlayCircle, component: PayrollRunList },
  { id: "structures", label: "Salary Structures", icon: Layers, component: SalaryStructureList },
  { id: "components", label: "Salary Components", icon: Settings, component: SalaryComponentList },
];
      ...
      >
        <div className="px-6 py-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className={`text-2xl font-bold ${isDarkMode ? "text-white" : "text-gray-900"}`}>Payroll</h1>
              <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                Payroll runs, structures & components
              </p>
            </div>
          </div>
        </div>
