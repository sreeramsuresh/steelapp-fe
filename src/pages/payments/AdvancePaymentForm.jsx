                  ...
                  <summary className="list-none cursor-pointer p-3 flex justify-between items-center">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <div className={`text-xs ${textMuted}`}>
                          Optional - link to outstanding invoice
                        </div>
                      </div>
                    </div>
                    <ChevronDown
                  ...
                  <div className={`p-3 border-t ${cardBorder}`}>
                    {loadingInvoices ? (
                      <div className="py-4 text-center">
                        <Loader2
                          className={`h-5 w-5 animate-spin mx-auto ${textMuted}`}
                        />
              ...
              <div className="lg:sticky lg:top-24 space-y-3">
                ...
                >
                  ...
                  >
                    ...
                    adjusted to prevent double taxation.
                  </p>
                </div>
              </div>
            </div>
