  ...
  const handleProductSelect = useCallback(
    async (index, productId) => {
      ...
      if (product) {
        ...
        let sellingPrice =
          product.sellingPrice || product.selling_price || product.price || 0;
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-1">
                  ...
                  <VatBadge
                    treatment={order.export_vat_treatment}
                    form201Box={order.form_201_box}
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                >
                  ...
                  transaction must be reported in Form 201 Box 2.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                  ...
                  >
                    ...
                    standard UAE treatment may apply.
                  </p>
                </div>
              </div>
            </div>
