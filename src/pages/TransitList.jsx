import { ChevronDown, Eye, Navigation, Search } from "lucide-react";
    ...
    return (
      ...
      >
        <div className="flex justify-center items-center min-h-[400px]">
          ...
          <span className={`ml-4 ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>Loading transit items...</span>
        </div>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-6">
          ...
          >
            <div className="py-4">
              ...
              <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Draft</p>
            </div>
          </div>
          <div
            className={`text-center border rounded-2xl shadow-sm ${
