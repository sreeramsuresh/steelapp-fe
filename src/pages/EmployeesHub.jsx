...
const tabs = [
  { id: "list", label: "Employees", icon: Users, component: EmployeeList },
  { id: "departments", label: "Departments", icon: Building2, component: DepartmentList },
  { id: "designations", label: "Designations", icon: Award, component: DesignationList },
];
