        ...
        <div className="px-6 py-4 max-h-[calc(100vh-200px)] overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              />
              {errors.issuing_bank && <p className="text-red-500 text-xs mt-1">{errors.issuing_bank}</p>}
            </div>
            ...
            {showAdvanced && (
              <div className="mt-4 space-y-4">
                ...
                <div>
                  ...
                  {formData.file && <p className="text-sm text-teal-600 mt-1">Selected: {formData.file.name}</p>}
                </div>
              </div>
            )}
          </div>
          ...
          {isAmendment && (
            <div className="mt-6 space-y-4">
              <h4 className={`font-medium ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Amendment Information</h4>
              ...
              <div>
                ...
                />
                {errors.amendment_details && <p className="text-red-500 text-xs mt-1">{errors.amendment_details}</p>}
              </div>
            </div>
          )}
        </div>
                  ...
                  >
                    <td className="px-4 py-3 whitespace-nowrap">
                      ...
                      {record.amendment_number > 0 && (
                        <div className="text-xs text-yellow-600">Amendment #{record.amendment_number}</div>
                      )}
                    </td>
                    <td className="px-4 py-3 whitespace-nowrap">
                    ...
                    <td className="px-4 py-3 whitespace-nowrap">
                      <span className="text-sm">{getLinkedOrderNumber(record.import_order_id)}</span>
                    </td>
                    <td className="px-4 py-3 whitespace-nowrap">
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-right">
                      <span className="font-medium">{formatCurrency(record.amount, record.currency)}</span>
                    </td>
                    <td className="px-4 py-3 whitespace-nowrap">
