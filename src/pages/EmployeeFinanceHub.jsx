...
import EmployeeAdvanceList from "./EmployeeAdvanceList";
import EmployeeLoanList from "./EmployeeLoanList";

const tabs = [
  { id: "advances", label: "Advances", icon: HandCoins, component: EmployeeAdvanceList },
  { id: "loans", label: "Loans", icon: Banknote, component: EmployeeLoanList },
];

const EmployeeFinanceHub = () => {
      ...
      >
        <div className="px-6 py-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className={`text-2xl font-bold ${isDarkMode ? "text-white" : "text-gray-900"}`}>Employee Finance</h1>
              <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Advances & loans</p>
            </div>
          </div>
        </div>
        <div className="px-6">
...
export default EmployeeFinanceHub;
