...
const StockMovementList = () => {
  ...
  const formatQuantityWithSign = (movement) => {
    ...
    const isInbound = ['IN', 'TRANSFER_IN', 'RELEASE'].includes(
  ...
  const totalPages =
    pagination.totalPages || Math.ceil((pagination.totalItems || 0) / 20);
                ...
                <div className="min-w-[180px]">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      {Object.entries(MOVEMENT_TYPES).map(
                        ([key, { label }]) => (
              ...
              {movements.map((movement) => (
                ...
                >
                  ...
                  >
                    ...
                    {movement.referenceType && (
                      <div
                        className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}
                      >
                        {REFERENCE_TYPES[movement.referenceType]?.label ||
                          movement.referenceType}
                      </div>
                    )}
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right">
                    <button
                      onClick={() =>
                        navigate(`/inventory/stock-movements/${movement.id}`)
                      }
