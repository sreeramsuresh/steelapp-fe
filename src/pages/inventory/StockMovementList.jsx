...
const StockMovementList = () => {
  ...
  const getMovementTypeBadge = (type) => {
    ...
    const colorClasses = {
      ...
      teal: isDarkMode
        ? 'bg-teal-900/30 text-teal-300 border-teal-600'
    ...
    return (
      <span className={`inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold rounded-full border ${colorClasses[config.color] || colorClasses.gray}`}>
