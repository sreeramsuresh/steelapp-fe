import { ArrowLeft, Banknote, Download, FileText, Receipt, TrendingDown, TrendingUp } from "lucide-react";
    ...
    return (
      ...
      >
        <div className="flex justify-center items-center min-h-[400px]">
          ...
          <span className={`ml-4 ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>Loading account statement...</span>
        </div>
      </div>
    );
  }
  ...
  if (error || !statement) {
    return (
      ...
      >
        ...
        >
          <p className={`text-lg ${isDarkMode ? "text-red-400" : "text-red-600"}`}>{error || "Statement not found"}</p>
        </div>
      </div>
    );
  }
    ...
    >
      ...
      >
        ...
        <div className="flex justify-between items-start mb-6 px-4 sm:px-0 pt-4 sm:pt-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className={`text-lg ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>{statement.statementNumber}</p>
            </div>
          </div>
          <button
            type="button"
              ...
              <div>
                ...
                <p
                  className={`text-lg font-semibold ${
                    statement.closingBalance > 0 ? "text-red-500" : "text-green-500"
                  }`}
                >
        ...
        {statement.notes && (
          ...
          >
            <h3 className={`text-sm font-medium mb-2 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Notes</h3>
            <p className={`${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>{statement.notes}</p>
          </div>
        )}
      </div>
    </div>
