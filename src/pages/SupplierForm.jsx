...
import { ArrowLeft, Save, Loader2, Building2, Globe, Factory, Clock } from 'lucide-react';
          ...
          <div className={`p-6 rounded-xl border ${
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={(e) => handleChange('supplierLocation', e.target.value)}
              ...
              <div>
                ...
                <div className={`flex items-center gap-4 h-[52px] px-4 rounded-lg border ${
              ...
              <div>
                <label className={labelClasses}>
                  ...
                  Primary Country {formData.supplierLocation === 'OVERSEAS' && '*'}
                </label>
                <div className="relative">
                  <select
              ...
              <div>
                ...
                />
                {errors.typicalLeadTimeDays && <p className="text-red-500 text-sm mt-1">{errors.typicalLeadTimeDays}</p>}
                <p className={`text-xs mt-1 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
