      ...
      const MockVATRefund = () => {
        ...
        return (
          <>
            ...
            {return_.refundDue > 0 && <div className="alert-info">Refund due to FTA for zero-rated exports</div>}
          </>
        );
      };
  ...
  describe("Documentation Requirements", () => {
    it("should include all required VAT fields on invoice document", async () => {
      const MockInvoiceDocument = () => {
        ...
        const requiredFields = ["invoiceNumber", "invoiceDate", "sellerTRN", "subtotal", "vatAmount", "total"];
