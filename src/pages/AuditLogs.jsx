                    ...
                    {filteredLogs.map((log) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-sm">
                          <span className={`px-2 py-1 rounded-full text-xs font-medium bg-${getCategoryColor(log.category)}-100 text-${getCategoryColor(log.category)}-800`}>
                            {log.category}
                          </span>
                        </td>
                        <td className={`px-4 py-3 text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-900'}`}>
                          {log.action}
                        </td>
