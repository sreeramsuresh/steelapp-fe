    ...
    return (
      <div className={`min-h-screen ${isDarkMode ? "bg-gray-900" : "bg-gray-50"} flex items-center justify-center`}>
        <div className="text-center">
          ...
          <p className={`mt-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Loading your commissions...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className={`text-2xl font-bold ${isDarkMode ? "text-white" : "text-gray-900"}`}>My Commissions</h1>
                <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                  Track your sales performance and earnings
                </p>
              </div>
            </div>
            <button type="button" onClick={loadAgentData}
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Total Commission Earned</p>
                  <p className={`text-3xl font-bold mt-1 ${isDarkMode ? "text-white" : "text-gray-900"}`}>
                    {formatCurrency(parseFloat(summary.totalCommission || 0))}
                  </p>
                </div>
                <div>
                  <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Average Commission Rate</p>
                  <p className={`text-3xl font-bold mt-1 ${isDarkMode ? "text-white" : "text-gray-900"}`}>
                  ...
                  <tbody className={`divide-y ${isDarkMode ? "divide-gray-700" : "divide-gray-200"}`}>
                    {transactions.map((transaction) => (
                      <tr key={transaction.id} className={isDarkMode ? "hover:bg-gray-700" : "hover:bg-gray-50"}>
                        ...
                        <td
                          className={`px-6 py-4 whitespace-nowrap font-semibold ${isDarkMode ? "text-white" : "text-gray-900"}`}
                        >
