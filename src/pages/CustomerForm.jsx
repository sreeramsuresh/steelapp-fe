...
const CustomerForm = () => {
  ...
  return (
    <div
      className={`p-0 sm:p-4 min-h-[calc(100vh-64px)] overflow-auto ${containerBg}`}
    >
      <div
        className={`p-6 mx-0 sm:mx-auto max-w-4xl rounded-none sm:rounded-2xl border ${cardBg}`}
      >
        {/* Header */}
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="text-sm">
                ...
                <p>
                  Enter the customer&apos;s basic contact and compliance
                  information. This helps identify the customer and maintain
                  accurate records.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="text-sm">
                <p className="font-semibold mb-1">
                  Credit Management (Phase 5)
                </p>
                <p>
                  View and manage customer credit limits, utilization, and
                  payment history. Credit grades (A-E) are automatically
                  calculated based on Days Sales Outstanding (DSO) and payment
                  history.
                </p>
              </div>
            </div>
              ...
              >
                {paymentHistory.length > 0 ? (
                  ...
                  <tr>
                    <td
                      colSpan={4}
                      className={`px-4 py-6 text-center text-sm ${mutedColor}`}
                    >
