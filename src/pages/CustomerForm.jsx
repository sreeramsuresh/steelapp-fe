                ...
                {customerId && (
                  <button
                    ...
                    className={`px-3 py-2 rounded-xl text-sm border transition-colors ${
                      isEditMode
                        ? isDarkMode ? 'border-red-500/50 bg-red-500/12 text-red-400' : 'border-red-200 bg-red-50 text-red-700'
                        : isDarkMode ? 'border-[#4aa3ff]/50 bg-[#4aa3ff]/12 text-[#4aa3ff]' : 'border-teal-200 bg-teal-50 text-teal-700'
                    }`}
                  >
            ...
            <div className="col-span-12 lg:col-span-8 space-y-3">
              ...
              <div className={`${cardBg} border ${cardBorder} rounded-2xl p-4`}>
                ...
                <div className="grid grid-cols-12 gap-3">
                  ...
                  {/* Company Name */}
                  <div className="col-span-12 md:col-span-6">
                    <label className={`block text-xs ${textMuted} mb-1.5`}>Company Name</label>
                    <input
                      type="text"
                      name="company"
                  ...
                  {/* Email */}
                  <div className="col-span-12 md:col-span-6">
                    <label className={`block text-xs ${textMuted} mb-1.5`}>Email</label>
                    <input
                      type="email"
                      name="email"
                  ...
                  {/* Phone */}
                  <div className="col-span-12 md:col-span-6">
                    <label className={`block text-xs ${textMuted} mb-1.5`}>Phone</label>
                    <input
                      type="tel"
                      name="phone"
                  ...
                  <div className="col-span-6 md:col-span-4">
                    <label className={`block text-xs ${textMuted} mb-1.5`}>Customer Code</label>
                    <input
                      type="text"
                      name="customerCode"
                  ...
                  {/* Payment Terms */}
                  <div className="col-span-6 md:col-span-4">
                    <label className={`block text-xs ${textMuted} mb-1.5`}>Payment Terms</label>
                    <input
                      type="text"
                      name="paymentTerms"
              ...
              <div className={`${cardBg} border ${cardBorder} rounded-2xl p-4`}>
                ...
                <div className="grid grid-cols-12 gap-3">
                  {/* VAT Number */}
                  <div className="col-span-12 md:col-span-6">
                    <label className={`block text-xs ${textMuted} mb-1.5`}>VAT Number</label>
                    <input
                      type="text"
                      name="vatNumber"
              ...
              <details className={`${accordionBg} border ${cardBorder} rounded-[14px] overflow-hidden group`}>
                <summary className="list-none cursor-pointer p-3 flex justify-between items-center">
                  <div>
                    ...
                    <div className={`text-xs ${textMuted}`}>Physical business address</div>
                  </div>
              ...
              <details open className={`${accordionBg} border ${cardBorder} rounded-[14px] overflow-hidden group`}>
                ...
                <div className={`p-3 border-t ${cardBorder} space-y-3`}>
                  ...
                  {isEditMode && (
                    <div className="grid grid-cols-12 gap-3">
                      <div className="col-span-6 md:col-span-4">
                        <label className={`block text-xs ${textMuted} mb-1.5`}>Credit Limit (AED)</label>
                        <input
                          type="number"
                          name="creditLimit"
                      ...
                      <div className="col-span-6 md:col-span-4">
                        <label className={`block text-xs ${textMuted} mb-1.5`}>DSO Value</label>
                        <input
                          type="number"
                          name="dsoValue"
                      ...
                      <div className="col-span-6 md:col-span-4">
                        <label className={`block text-xs ${textMuted} mb-1.5`}>Credit Utilization (%)</label>
                        <input
                          type="number"
              ...
              <div className="lg:sticky lg:top-24 space-y-3">
                ...
                {customerId && (
                  <div className={`${cardBg} border ${cardBorder} rounded-2xl p-4`}>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className={`text-2xl font-extrabold ${
                          creditData.creditGrade === 'A' ? 'text-green-500' :
                          creditData.creditGrade === 'B' ? 'text-green-400' :
                          creditData.creditGrade === 'C' ? 'text-yellow-500' :
                          creditData.creditGrade === 'D' ? 'text-orange-500' : 'text-red-500'
                        }`}>
                    ...
                    <div className="mt-3 pt-3 border-t border-dashed" style={{borderColor: isDarkMode ? '#2a3640' : '#e5e7eb'}}>
                      <div className="flex justify-between text-sm">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className={`text-xs mt-1 ${isDarkMode ? 'text-[#93a4b4]' : 'text-blue-600'}`}>
                        Credit grades (A-E) are calculated from DSO and payment history. Lower DSO indicates faster payments.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <Dialog open={isAgingModalOpen} onOpenChange={setIsAgingModalOpen}>
        <DialogContent className={isDarkMode ? 'bg-[#141a20] border-[#2a3640]' : 'bg-white'}>
          ...
          <div className="space-y-3">
            {[
              { label: 'Current (0 days)', value: creditData.agingCurrent, color: 'text-green-500' },
              { label: '1-30 days overdue', value: creditData.aging1To30, color: 'text-yellow-500' },
              { label: '31-60 days overdue', value: creditData.aging31To60, color: 'text-orange-500' },
              { label: '61-90 days overdue', value: creditData.aging61To90, color: 'text-orange-600' },
              { label: '90+ days overdue', value: creditData.aging90Plus, color: 'text-red-500' },
            ].map((bucket, idx) => (
            ...
            <div className={`border-t pt-3 flex items-center justify-between font-bold ${cardBorder}`}>
              ...
              <span className={`font-mono ${textPrimary}`}>
                AED {(
                  creditData.agingCurrent + creditData.aging1To30 + creditData.aging31To60 +
                  creditData.aging61To90 + creditData.aging90Plus
