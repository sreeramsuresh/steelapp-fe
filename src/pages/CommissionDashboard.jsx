  ...
  const handleBatchCalculate = async () => {
    ...
    try {
      ...
      notificationService.error(
        error.message || 'Failed to calculate commissions',
      );
    } finally {
                    ...
                    dashboardData.topAgents.slice(0, 5).map((agent, index) => (
                      ...
                      >
                        ...
                        <div className="text-right">
                          ...
                          >
                            {formatCurrency(
                              parseFloat(agent.totalCommission || 0),
                            )}
                          </p>
                          <p
                            className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}
                          >
                            Sales:{' '}
                            {formatCurrency(parseFloat(agent.totalSales || 0))}
                          </p>
                        </div>
                      </div>
                    ))
                      ...
                      dashboardData.recentTransactions.map((transaction) => (
                        ...
                        >
                          ...
                          >
                            ...
                            <span
                              className={`ml-1 text-xs ${isDarkMode ? 'text-gray-500' : 'text-gray-500'}`}
                            >
