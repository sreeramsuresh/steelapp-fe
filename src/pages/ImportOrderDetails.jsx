...
const ImportOrderDetails = () => {
  ...
  const cifValue =
    order.cifValue || order.cif_value || parseFloat(subtotal) + parseFloat(freightCost) + parseFloat(insuranceCost);
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className={`text-sm mt-1 ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>Import Order Details</p>
          </div>
          {/* Status Badge */}
          <span
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                ...
                <p className={`font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}>{formatDate(orderDate)}</p>
              </div>
              <div>
                <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>PI Number</p>
                <p className={`font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}>{piNumber || "N/A"}</p>
              </div>
              <div>
                <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>PO Number</p>
                <p className={`font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}>{poNumber || "N/A"}</p>
              </div>
              <div>
                <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>Created</p>
                <p className={`font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}>{formatDate(createdAt)}</p>
              </div>
              {createdBy && (
                <div>
                  <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>Created By</p>
                  <p className={`font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}>{createdBy}</p>
                </div>
              )}
              {updatedAt && (
                <div>
            ...
            <div className={`p-4 rounded-lg mb-4 ${isDarkMode ? "bg-gray-800" : "bg-gray-50"}`}>
              <div className="flex items-center justify-between">
                <div className="text-center">
                  ...
                  <p className={`text-sm font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}>{originPort}</p>
                ...
                {((order.movement_type || order.movementType) === "dz_entry" ||
                  ...
                  >
                    <p className={isDarkMode ? "text-green-300" : "text-green-800"}>
                      ...
                      {order.designated_zone_name || order.designatedZoneName || "designated zone"} qualify for 0% VAT
                      under UAE VAT Law Article 51.
                    </p>
                  </div>
                )}
              </div>
          ...
          >
            ...
            <div className="space-y-2">
              {documents.filter((doc) => doc.category === activeDocTab || (!doc.category && activeDocTab === "trade"))
                .length === 0 ? (
          ...
          {notes && (
            ...
            >
              ...
              <p className={`text-sm whitespace-pre-wrap ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>{notes}</p>
            </div>
          )}
        </div>
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div className="space-y-3">
              ...
              {/* Customs Duty */}
              <div className="flex justify-between">
                <span className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>Customs Duty (5%)</span>
                <span className={`font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}>
              ...
              <div className={`p-4 rounded-lg ${isDarkMode ? "bg-teal-900/30" : "bg-teal-50"}`}>
                <div className="flex justify-between items-center">
                  <span className={`font-semibold ${isDarkMode ? "text-teal-300" : "text-teal-800"}`}>Grand Total</span>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    {(order.exchange_rate_date || order.exchangeRateDate) && (
                      <div>
                        ...
                        <span className={isDarkMode ? "text-gray-300" : "text-gray-700"}>
                          {formatDate(order.exchange_rate_date || order.exchangeRateDate)}
                        </span>
                      </div>
                    )}
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className={`font-medium font-mono ${isDarkMode ? "text-indigo-100" : "text-indigo-900"}`}>
                        {formatCurrency(
                          order.goods_imported_value || order.goodsImportedValue || cifValue + customsDuty,
                          "AED"
                        )}
                      </span>
                    </div>
