...
export default function SignOffWorkflow() {
  ...
  const handleSignOff = async (stage) => {
    ...
    try {
      ...
      // Refresh sign-offs
      const updated = await auditHubService.getSignOffs(
        user.companyId,
        datasetId,
      );
      setSignOffs(updated);
                          ...
                          {isCompleted ? (
                            ...
                            <div className="space-y-3">
                              {showCommentModal === stage.name ? (
                                <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg">
                                  ...
                                  <div className="flex gap-2 mt-3">
                                    <button
                                      ...
                                      disabled={
                                        submitting[stage.name] ||
                                        !comments[stage.name]?.trim()
                                      }
                                ...
                                <button
                                  onClick={() =>
                                    setShowCommentModal(stage.name)
                                  }
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-800 dark:text-green-200 mt-1">
                      This period is now locked. No further modifications
                      allowed.
                    </p>
                  </div>
                </div>
