  ...
  if (!hasAnyTabAccess) {
    return (
      <div className={`min-h-screen flex items-center justify-center ${
        ...
        <div className="flex flex-col items-center gap-4 max-w-md text-center">
          <div className={`text-5xl ${isDarkMode ? 'text-yellow-400' : 'text-yellow-600'}`}>
            🔒
          </div>
          <h2 className={`text-xl font-semibold ${
            isDarkMode ? 'text-gray-200' : 'text-gray-800'
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-[#121418]' : 'bg-[#FAFAFA]'}`}>
      ...
      <div className={`mb-6 p-6 ${
        ...
        <span className={`inline-block mt-3 px-3 py-1 text-sm font-medium uppercase tracking-wider rounded-full ${
