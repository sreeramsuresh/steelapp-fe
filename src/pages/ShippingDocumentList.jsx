...
const DOCUMENT_TYPES = [
  { value: 'bill_of_lading', label: 'Bill of Lading (BOL)', icon: Ship, color: 'blue' },
  { value: 'airway_bill', label: 'Airway Bill (AWB)', icon: Plane, color: 'purple' },
  { value: 'packing_list', label: 'Packing List', icon: Package, color: 'green' },
  { value: 'shipping_instruction', label: 'Shipping Instruction', icon: FileText, color: 'yellow' },
  { value: 'delivery_order', label: 'Delivery Order', icon: Truck, color: 'orange' },
];

// Status Configuration
const STATUS_CONFIG = {
  pending: { label: 'Pending', color: 'gray', bgLight: 'bg-gray-100', bgDark: 'bg-gray-700', textLight: 'text-gray-700', textDark: 'text-gray-300' },
  shipped: { label: 'Shipped', color: 'blue', bgLight: 'bg-blue-100', bgDark: 'bg-blue-900/30', textLight: 'text-blue-700', textDark: 'text-blue-300' },
  in_transit: { label: 'In Transit', color: 'yellow', bgLight: 'bg-yellow-100', bgDark: 'bg-yellow-900/30', textLight: 'text-yellow-700', textDark: 'text-yellow-300' },
  arrived: { label: 'Arrived', color: 'orange', bgLight: 'bg-orange-100', bgDark: 'bg-orange-900/30', textLight: 'text-orange-700', textDark: 'text-orange-300' },
  delivered: { label: 'Delivered', color: 'green', bgLight: 'bg-green-100', bgDark: 'bg-green-900/30', textLight: 'text-green-700', textDark: 'text-green-300' },
  cancelled: { label: 'Cancelled', color: 'red', bgLight: 'bg-red-100', bgDark: 'bg-red-900/30', textLight: 'text-red-700', textDark: 'text-red-300' },
};
  ...
  return (
    <div className={`p-6 min-h-screen ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
          <div className={`relative w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-lg shadow-xl ${
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {modalMode === 'create' ? 'Create a new BOL, AWB or shipping document' : `Editing ${selectedDocument?.document_number}`}
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  {formErrors.document_type && (
                    <p className="text-red-500 text-xs mt-1">{formErrors.document_type}</p>
                  )}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1">Link to Import Order</label>
                  <select
              ...
              <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-700/50' : 'bg-gray-50'}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium mb-1">Vessel / Flight Name</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">Voyage / Flight Number</label>
                    <input
                      type="text"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1">Container Numbers</label>
                  <textarea
                ...
                <div>
                  <label className="block text-sm font-medium mb-1">Seal Numbers</label>
                  <textarea
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    {formErrors.origin_port && (
                      <p className="text-red-500 text-xs mt-1">{formErrors.origin_port}</p>
                    )}
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1">
              ...
              <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-700/50' : 'bg-gray-50'}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">Actual Departure</label>
                    <input
                      type="date"
              ...
              <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-700/50' : 'bg-gray-50'}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">Notify Party</label>
                    <input
                      type="text"
      ...
      {showModal && modalMode === 'view' && selectedDocument && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
          <div className={`relative w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-lg shadow-xl ${
            isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'
          }`}>
            {/* Header */}
            <div className={`sticky top-0 flex items-center justify-between p-6 border-b ${
                ...
                <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-700/30' : 'bg-gray-50'}`}>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{selectedDocument.weight_kg ? `${selectedDocument.weight_kg} KG` : '-'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-500">Volume:</span>
                      <span className="font-medium">{selectedDocument.volume_cbm ? `${selectedDocument.volume_cbm} CBM` : '-'}</span>
                    </div>
                    <div className="flex justify-between">
