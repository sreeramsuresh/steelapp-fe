...
import CostCenterBudgetList from "./CostCenterBudgetList";
import CostCenterList from "./CostCenterList";

const tabs = [
  { id: "list", label: "Cost Centers", icon: Landmark, component: CostCenterList },
  { id: "budgets", label: "Budgets", icon: Wallet, component: CostCenterBudgetList },
];

const CostCentersHub = () => {
      ...
      >
        <div className="px-6 py-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className={`text-2xl font-bold ${isDarkMode ? "text-white" : "text-gray-900"}`}>Cost Centers</h1>
              <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Cost centers & budgets</p>
            </div>
          </div>
        </div>
        <div className="px-6">
