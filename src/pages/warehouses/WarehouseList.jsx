...
import { MapPin, Package, Plus, RefreshCw, Search } from "lucide-react";
    ...
    <div className={`min-h-screen ${isDarkMode ? "bg-[#121418]" : "bg-gray-50"}`}>
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <button type="button" onClick={fetchWarehouses}
      ...
      {/* Filters */}
      <div
        className={`mx-6 mb-4 p-4 rounded-lg ${isDarkMode ? "bg-[#1E2328]" : "bg-white"} border ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}
      >
      ...
      <div className="px-6 pb-6">
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className={`h-48 rounded-lg animate-pulse ${isDarkMode ? "bg-gray-700" : "bg-gray-200"}`} />
            ))}
          </div>
        ) : filteredWarehouses.length === 0 ? (
          <div
            className={`text-center py-12 rounded-lg ${isDarkMode ? "bg-[#1E2328]" : "bg-white"} border ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}
          >
