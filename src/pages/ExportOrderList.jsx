  ...
  return (
    <div className={`p-6 min-h-screen ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
      ...
      {selectedOrders.length > 0 && (
        <div className={`${isDarkMode ? 'bg-teal-900/30 border-teal-700' : 'bg-teal-50 border-teal-200'} border rounded-lg p-3 mb-4 flex items-center justify-between`}>
      ...
      <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-sm overflow-hidden`}>
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              {/* Total Summary Row */}
              <tfoot className={`${isDarkMode ? 'bg-gray-700' : 'bg-gray-50'} border-t-2 ${isDarkMode ? 'border-gray-600' : 'border-gray-300'}`}>
                <tr>
                  <td colSpan="5" className={`px-6 py-3 text-sm font-semibold text-right ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
        ...
        {pagination.total_pages > 1 && (
          <div className={`px-6 py-3 flex flex-col sm:flex-row items-center justify-between border-t gap-3 ${
