...
const MaterialCertificateList = () => {
  ...
  const handleEdit = (cert) => {
    setFormData({
      ...
      certificate_issuer: cert.certificateIssuer || "",
      accreditation_body: cert.accreditationBody || "",
      standard_specification: cert.standardSpecification || "",
      en_10204_type: cert.en10204Type || "",
      product_form: cert.productForm || "",
      heat_treatment_condition: cert.heatTreatmentCondition || "",
      issue_date: cert.issueDate ? cert.issueDate.split("T")[0] : "",
      expiry_date: cert.expiryDate ? cert.expiryDate.split("T")[0] : "",
      coo_validity_date: cert.cooValidityDate || "",
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          >
            ...
            {(filters.certificate_type ||
              ...
              filters.grade ||
              filters.start_date ||
              filters.end_date) && <span className="w-2 h-2 bg-teal-500 rounded-full"></span>}
          </button>
        ...
        {showFilters && (
          <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              ...
              {/* Grade */}
              <div>
                <label htmlFor="filter-grade" className="block text-sm font-medium mb-1">
                  Grade
                </label>
                <select
                  id="filter-grade"
              ...
              <div className={`p-4 rounded-lg ${isDarkMode ? "bg-gray-700/50" : "bg-gray-50"}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    />
                    {formErrors.mill_name && <p className="text-red-500 text-xs mt-1">{formErrors.mill_name}</p>}
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div>
                    <label htmlFor="modal-heat-number" className="block text-sm font-medium mb-1">
                      Heat Number{" "}
                      {formData.certificate_type === "mill_test_certificate" && <span className="text-red-500">*</span>}
                    </label>
                    <input
                    ...
                    />
                    {formErrors.heat_number && <p className="text-red-500 text-xs mt-1">{formErrors.heat_number}</p>}
                  </div>
                  ...
                  {formData.grade === "OTHER" && (
                    <div>
                      ...
                      />
                      {formErrors.grade_other && <p className="text-red-500 text-xs mt-1">{formErrors.grade_other}</p>}
                    </div>
                  )}
                </div>
              </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-lg font-medium">{selectedCertificate.hardness || "-"}</div>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="flex items-center gap-3">
                <div
                  className={`p-2 rounded-lg ${
                    verifyAction === "verify" ? "bg-green-100 dark:bg-green-900/30" : "bg-red-100 dark:bg-red-900/30"
                  }`}
                >
                  {verifyAction === "verify" ? (
            ...
            <div className="p-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={
                    verifyAction === "verify" ? "Add any verification notes..." : "Enter reason for rejection..."
                  }
                  rows={4}
                  className={`w-full px-3 py-2 border rounded-lg ${
                    isDarkMode
