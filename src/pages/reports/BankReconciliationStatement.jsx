...
export default function BankReconciliationStatement() {
  ...
  const fetchBRS = async () => {
    ...
    try {
      const result =
        await bankReconciliationService.getBankReconciliation(statementId);
      setData(result);
    } catch (err) {
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <div className="grid grid-cols-2 gap-8 mb-6">
                ...
                <div className="space-y-2 text-sm">
                  <p>
                    ...
                    <span className="ml-2 font-medium">
                      {bankReconciliationService.formatDate(
                  ...
                  <p>
                    ...
                    <span
                      className={`ml-2 font-medium ${data.is_balanced ? 'text-green-600' : 'text-red-600'}`}
                    >
              ...
              <div>
                ...
                <div
                  className={`text-4xl font-bold ${data.is_balanced ? 'text-green-600' : 'text-red-600'}`}
                >
