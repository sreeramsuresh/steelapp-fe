      ...
      {summary && (
        <div className="grid grid-cols-5 gap-4 mb-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <div className="text-xl font-bold">{data?.pagination?.total || 0}</div>
          </div>
        </div>
      )}
              ...
              {summary.summary.map((day, idx) => (
                <tr key={idx} className="border-b hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-center text-sm">
                    <span className="bg-green-100 text-green-800 px-2 py-1 rounded text-xs">{day.receipt_count}</span>
                  </td>
                  <td className="px-4 py-3 text-center text-sm">
                    <span className="bg-red-100 text-red-800 px-2 py-1 rounded text-xs">{day.payment_count}</span>
                  </td>
                </tr>
              ))}
            </tbody>
