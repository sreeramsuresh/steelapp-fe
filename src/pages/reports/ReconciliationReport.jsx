              ...
              <table className="min-w-full divide-y ${isDarkMode ? 'divide-gray-700' : 'divide-gray-200'}">
                ...
                >
                  ...
                  >
                    ...
                    >
                      {formatNumber(
                        filteredData.reduce((sum, item) => sum + item.openingStock, 0)
                      )}
                    </td>
                    <td className="px-4 py-3 text-sm text-right text-green-600">
                    ...
                    >
                      {filteredData.reduce((sum, item) => sum + item.adjustments, 0) >= 0
                        ...
                        : ''}
                      {formatNumber(
                        filteredData.reduce((sum, item) => sum + item.adjustments, 0)
                      )}
                    </td>
                    <td
                      className={`px-4 py-3 text-sm text-right ${
                    ...
                    >
                      {formatNumber(
                        filteredData.reduce((sum, item) => sum + item.expectedClosing, 0)
                      )}
                    </td>
                    <td
                      className={`px-4 py-3 text-sm text-right ${
                    ...
                    >
                      {formatNumber(
                        filteredData.reduce((sum, item) => sum + item.systemStock, 0)
                      )}
                    </td>
                    <td
                      className={`px-4 py-3 text-sm text-right ${
