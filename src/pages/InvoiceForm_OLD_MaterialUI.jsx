...
const InvoiceForm = ({ onSave }) => {
  ...
  }, [isMobile, isSmallScreen, theme.breakpoints.values]);
            ...
            <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                  <SectionHeader variant="h6">🏗️ Steel Items [UPDATED WITH NEW FIELDS]</SectionHeader>
                  {/* Debug indicator - remove in production */}
                  <Typography variant="caption" color="text.secondary">
                    {isMobile ? "(Mobile View)" : "(Desktop View)"} | Screen: {window.innerWidth}px
                  </Typography>
                </Box>
                <Button
                  onClick={addItem}
              ...
              <DesktopTableContainer sx={{ overflowX: "auto" }}>
                <Alert severity="info" sx={{ mb: 2 }}>
                  ✅ NEW FIELDS LOADED: This table now includes Finish, Size, and Thickness columns
                </Alert>
                <Table sx={{ minWidth: 1500, tableLayout: "auto", width: "100%" }}>
                  <TableHead>
                    <TableRow>
                      <TableCell sx={{ minWidth: 200 }}>
                        Product Selection
                      </TableCell>
                      <TableCell sx={{ minWidth: 120, fontWeight: 600, backgroundColor: '#f5f5f5' }}>Grade</TableCell>
                      <TableCell sx={{ minWidth: 120, fontWeight: 600, backgroundColor: '#f0f8ff' }}>Finish</TableCell>
                      <TableCell sx={{ minWidth: 120, fontWeight: 600, backgroundColor: '#f0fff0' }}>Size</TableCell>
                      <TableCell sx={{ minWidth: 120, fontWeight: 600, backgroundColor: '#fff8f0' }}>Thickness</TableCell>
