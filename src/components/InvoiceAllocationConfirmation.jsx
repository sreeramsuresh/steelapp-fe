            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-800">
                  ...
                  allocation below and confirm within {formatTime(timeRemaining)}.
                  If no action is taken, the allocation will be automatically
                  confirmed.
                </p>
              </div>
            </div>
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <div className="flex items-center gap-4 ml-2">
                      {warehouses.map((wh) => {
                        const whAllocations = allocations.filter(
                          (a) => a.warehouseId === wh.id,
                        );
                        const totalQty = whAllocations.reduce(
