              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  {supplierAddress.street && (
                    <p className="text-sm">{supplierAddress.street}</p>
                  )}
                  ...
                  {supplierDetails.vatNumber && (
                    <p className="text-sm mt-1">VAT: {supplierDetails.vatNumber}</p>
                  )}
                </div>
                <div className="text-right">
                  <div className="mb-2">
                  ...
                  <div className="mb-2">
                    <span className={`inline-block px-2 py-1 text-xs font-medium rounded ${getStatusColor(purchaseOrder.status)}`}>
              ...
              <div className={`border rounded-lg p-4 ${isDarkMode ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-gray-50'}`}>
                ...
                {(purchaseOrder.otherCharges || purchaseOrder.other_charges) && (
                  <div className="flex justify-between py-1 text-sm">
                    ...
                    <span>{formatCurrency(parseFloat(purchaseOrder.otherCharges || purchaseOrder.other_charges) || 0)}</span>
                  </div>
                )}
                ...
                <div className={`mt-6 pt-4 border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                  ...
                  {(purchaseOrder.termsAndConditions || purchaseOrder.terms_and_conditions) && (
                    <div>
                      ...
                      <p className="text-sm whitespace-pre-wrap">{purchaseOrder.termsAndConditions || purchaseOrder.terms_and_conditions}</p>
                    </div>
                  )}
                </div>
              )}
