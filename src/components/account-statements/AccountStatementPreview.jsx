          ...
          <div className={`max-w-3xl mx-auto ${isDarkMode ? 'bg-gray-900' : 'bg-white'} shadow-lg rounded-lg overflow-hidden`}>
            ...
            <div className={`p-6 ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`}>
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                ...
                <div className="text-right">
                  <div className="mb-2">
                    <span className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Statement Period: </span>
                    <span className="font-medium">
                      {formatDate(statement.fromDate || statement.from_date)} - {formatDate(statement.toDate || statement.to_date)}
                    </span>
                  </div>
                  <div className="mb-2">
