    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          <ReceiptText className={`h-5 w-5 ${isDarkMode ? "text-purple-400" : "text-purple-600"}`} />
          <h3 className={`font-semibold ${isDarkMode ? "text-white" : "text-gray-900"}`}>Credit Notes</h3>
      ...
      <div className="p-4">
        {loading ? (
          ...
          <div className={`flex items-center gap-2 py-4 ${isDarkMode ? "text-red-400" : "text-red-600"}`}>
          ...
          <div className={`text-center py-6 ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>
            ...
            {canCreateCreditNote && <p className="text-xs mt-1">Click &quot;New&quot; to create one</p>}
          </div>
        ) : (
          <>
            {/* Credit Notes List */}
            <div className="space-y-2">
              {creditNotes.map((cn) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <span className={`font-medium text-sm ${isDarkMode ? "text-red-400" : "text-red-600"}`}>
