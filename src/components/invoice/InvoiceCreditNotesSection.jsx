...
const InvoiceCreditNotesSection = ({
  invoiceId,
  invoiceStatus,
  isDarkMode,
}) => {
  ...
  const canCreateCreditNote =
    invoiceStatus === 'issued' || invoiceStatus === 'STATUS_ISSUED';
  ...
  const loadCreditNotes = async () => {
    try {
      ...
      setError(null);
      const response =
        await creditNoteService.getCreditNotesByInvoice(invoiceId);
