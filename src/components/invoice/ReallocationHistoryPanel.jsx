...
import { History, ChevronDown, ChevronRight, AlertCircle, TrendingUp, TrendingDown } from 'lucide-react';
...
const ReallocationHistoryPanel = ({
  ...
  const getReasonBadge = (reasonCode) => {
    ...
    const reason = reasonLabels[reasonCode] || { label: reasonCode, color: 'gray' };
    const colorClasses = {
                  ...
                  {history.map((entry, index) => (
                    ...
                    >
                      ...
                      <TableCell className="text-right font-medium">
                        {entry.quantityChanged || entry.quantity_changed ||
                          (entry.newQuantity || entry.new_quantity || 0)}
                      </TableCell>
