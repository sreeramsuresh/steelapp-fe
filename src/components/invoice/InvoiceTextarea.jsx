  ...
  return (
    <div className="space-y-1">
      ...
      <textarea
        id={textareaId}
        ref={textareaRef}
        className={`w-full px-3 py-2 border rounded-lg shadow-xs focus:ring-2 focus:ring-teal-500 focus:border-teal-500 focus:-translate-y-0.5 transition-all duration-300 resize-none ${
          isDarkMode
