...
import { ChevronDown, Ship, Truck, Warehouse } from "lucide-react";
 ...
 */
const SourceTypeSelector = ({ value = "WAREHOUSE", onChange, disabled = false, id, "data-testid": dataTestId }) => {
    ...
    <SelectPrimitive.Root value={value} onValueChange={onChange} disabled={disabled}>
      ...
      >
        <div className="flex items-center gap-2">
          <SelectedIcon className={cn("h-4 w-4", isDarkMode ? "text-gray-400" : "text-gray-500")} />
          <SelectPrimitive.Value />
        </div>
        <SelectPrimitive.Icon asChild>
          <ChevronDown className={cn("h-3.5 w-3.5", isDarkMode ? "text-gray-400" : "text-gray-500")} />
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <SelectPrimitive.ItemText>{option.shortLabel}</SelectPrimitive.ItemText>
                  </div>
                </SelectPrimitive.Item>
              );
            })}
