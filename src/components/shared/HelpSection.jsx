...
const HelpSection = ({
  ...
  const variantStyles = {
    ...
    warning: 'bg-orange-50 dark:bg-orange-900 border-orange-200 dark:border-orange-700 text-orange-900 dark:text-orange-100',
  ...
  return (
    <div className={`p-4 rounded-lg border ${variantStyles[variant]}`}>
      <div className="flex items-start gap-3 mb-3">
        ...
        {title && (
          <h3 className={`font-semibold text-sm ${headerTextColor[variant]}`}>
            {title}
          </h3>
        )}
      </div>
