...
describe("TextInput", () => {
  ...
  it("should render input with label", () => {
    render(
      <TextInput label="Email Address" value="" onChange={mockOnChange} />
    );
  ...
  it("should display required indicator when required is true", () => {
    render(
      <TextInput label="Username" value="" onChange={mockOnChange} required={true} />
    );
  ...
  it("should call onChange when input changes", async () => {
    ...
    render(
      <TextInput label="Email" value="" onChange={mockOnChange} />
    );
  ...
  it("should apply correct type attribute", () => {
    render(
      <TextInput type="email" label="Email" value="" onChange={mockOnChange} />
    );
  ...
  it("should handle different input types", () => {
    const { rerender } = render(
      <TextInput type="password" label="Password" value="" onChange={mockOnChange} />
    );

    expect(screen.getByLabelText("Password")).toHaveAttribute("type", "password");

    rerender(
      <TextInput type="number" label="Age" value="" onChange={mockOnChange} />
    );
  ...
  it("should disable input when disabled is true", () => {
    render(
      <TextInput label="Disabled Field" value="" onChange={mockOnChange} disabled={true} />
    );
  ...
  it("should display current value", () => {
    render(
      <TextInput label="Email" value="test@example.com" onChange={mockOnChange} />
    );
