  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="w-10 h-10 rounded-lg bg-linear-to-br from-indigo-600 to-purple-700 flex items-center justify-center text-white">
            <BarChart3 size={20} />
          </div>
          <div>
                      ...
                      <div key={item.id || item.name || `item-${itemIndex}`} className="px-2">
                        <Link
                          ...
                          className={`flex items-center gap-3 px-3 py-2.5 rounded-lg min-h-12 transition-all duration-200 no-underline group ${
                            isActive
                              ? "bg-linear-to-br from-indigo-600 to-purple-700 text-white hover:text-white shadow-md"
                              : isDarkMode
