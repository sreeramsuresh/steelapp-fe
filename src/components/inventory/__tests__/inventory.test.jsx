  ...
  it("renders batch cost breakdown", () => {
    const MockBatchCost = () => (
      <div data-testid="batch-cost-table">
        ...
        <table>
          <thead><tr><th>Batch</th><th>Product</th><th>Qty</th><th>Unit Cost</th><th>Total Cost</th></tr></thead>
          <tbody>
            <tr><td>B-001</td><td>SS-304-Sheet</td><td>100</td><td>90 AED</td><td>9,000 AED</td></tr>
            <tr><td>B-002</td><td>SS-304-Sheet</td><td>50</td><td>95 AED</td><td>4,750 AED</td></tr>
          </tbody>
        </table>
...
describe("ProductBatchDrawer", () => {
  it("renders batch drawer with product details", () => {
    const MockBatchDrawer = ({ isOpen }) => {
      ...
      return (
        <div data-testid="batch-drawer" role="complementary">
          <h3>SS-304-Sheet — Batches</h3>
          <table>
            <thead><tr><th>Batch</th><th>GRN</th><th>Received</th><th>Available</th><th>Reserved</th></tr></thead>
            <tbody>
              <tr><td>B-001</td><td>GRN-001</td><td>100</td><td>80</td><td>20</td></tr>
              <tr><td>B-002</td><td>GRN-005</td><td>50</td><td>50</td><td>0</td></tr>
            </tbody>
          </table>
  ...
  it("renders FIFO allocation interface", () => {
    ...
    const MockAllocator = () => (
      <div data-testid="batch-allocator">
        ...
        <table>
          <thead><tr><th>Batch</th><th>Available</th><th>Allocate</th></tr></thead>
          <tbody>
            <tr>
              <td>B-001 (oldest)</td>
              <td>80</td>
