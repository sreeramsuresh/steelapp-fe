...
const OrderBlockingLogic = ({
  ...
  const isBlocked =
    customer?.creditGrade && ['D', 'E'].includes(customer.creditGrade);
        ...
        >
          ...
          >
            <div className="flex items-start gap-3">
              <div
                className={`p-2 rounded-lg ${getGradeBg(customer.creditGrade)}`}
              >
                <XCircle
                  className={`w-6 h-6 ${getGradeColor(customer.creditGrade)}`}
                />
              </div>
              <div>
                <h2
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed">
                Orders are blocked for customers with severe credit issues
                (Grades D & E).
                {daysSincePayment && (
                  <>
                    {' '}
                    ...
                    since last payment, exceeding the threshold of{' '}
                    {dsoThreshold} days.
                  </>
                )}
              </p>
              ...
              {overdueAmount > 0 && (
                ...
                >
                  <span className="font-medium">Current Overdue:</span> AED{' '}
            ...
            >
              ...
              <p className="text-sm">
                Please contact the customer to arrange payment for outstanding
                invoices before processing new orders.
              </p>
            </div>
          </div>
          ...
          {showConfirmation && selectedAction === 'approve' ? (
            ...
            >
              ...
              <ul
                className={`text-sm space-y-1 mb-4 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}
              >
