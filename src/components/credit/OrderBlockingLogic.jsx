          ...
          <div className={`px-5 py-4 space-y-4 ${
            ...
            <div className={`p-3 rounded-lg ${
              ...
              <p className="text-sm mt-1">
                ...
                <span className={`ml-2 px-2 py-0.5 rounded text-xs font-bold ${getGradeBg(customer.creditGrade)} ${getGradeColor(customer.creditGrade)}`}>
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed">
                ...
                {daysSincePayment && (
                  <>
                    {' '}This customer has{' '}
                    <span className="font-medium">{daysSincePayment} days</span> since last payment,
            ...
            <div className={`p-3 rounded-lg border-l-4 ${
              ...
              <p className="text-sm">
                Please contact the customer to arrange payment for outstanding invoices
                before processing new orders.
              </p>
            </div>
          </div>
