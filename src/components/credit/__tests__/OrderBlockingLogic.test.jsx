...
describe("OrderBlockingLogic", () => {
  it("returns null when not open", () => {
    const { container } = render(
      <OrderBlockingLogic customer={blockedCustomer} isOpen={false} onClose={() => {}} />
    );
  ...
  it("returns null when customer is null", () => {
    const { container } = render(
      <OrderBlockingLogic customer={null} isOpen={true} onClose={() => {}} />
    );
    expect(container.innerHTML).toBe("");
  });
  ...
  it("returns null when customer is not blocked (grade A)", () => {
    ...
    const { container } = render(
      <OrderBlockingLogic customer={goodCustomer} isOpen={true} onClose={() => {}} />
    );
    expect(container.innerHTML).toBe("");
  });
  ...
  it("renders modal for blocked customer (grade D)", () => {
    render(
      <OrderBlockingLogic customer={blockedCustomer} isOpen={true} onClose={() => {}} />
    );
  ...
  it("renders modal for grade E customer", () => {
    ...
    render(
      <OrderBlockingLogic customer={gradeE} isOpen={true} onClose={() => {}} />
    );
    expect(screen.getByText("Order Blocked")).toBeInTheDocument();
  });
  ...
  it("calls onClose when cancel order is clicked", () => {
    const onClose = vi.fn();
    render(
      <OrderBlockingLogic customer={blockedCustomer} isOpen={true} onClose={onClose} />
    );
