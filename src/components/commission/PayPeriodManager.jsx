    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        >
          ...
          <h3 className={`text-lg font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}>No Pay Periods</h3>
         ...
         onClick={() => setSelectedPeriod(selectedPeriod === period.id ? null : period.id)}
                  onKeyDown={(e) => {
                    if (e.key === "Enter" || e.key === " ") {
                      e.preventDefault();
                      setSelectedPeriod(selectedPeriod === period.id ? null : period.id);
                    }
                  }}
                >
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="text-right">
                      ...
                      <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>{agentCount} agents</p>
                    </div>
                    <ChevronRight
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                      <div className={`p-3 rounded-lg ${isDarkMode ? "bg-gray-700" : "bg-white"}`}>
                        <div className="flex items-center space-x-2">
                          ...
                          <span className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Agents</span>
                        </div>
            ...
            <div className="p-6">
              {confirmAction.type === "close" ? (
                <p className={isDarkMode ? "text-gray-300" : "text-gray-600"}>
                  Closing this pay period will prevent any new commissions from being added. All approved commissions
                  will be locked and ready for payment processing.
                </p>
              ) : (
                <p className={isDarkMode ? "text-gray-300" : "text-gray-600"}>
                  This will mark all commissions in this period as paid. Make sure all actual payments have been
              ...
              <div className={`mt-4 p-3 rounded-lg ${isDarkMode ? "bg-gray-700" : "bg-gray-100"}`}>
                ...
                <p className={`font-semibold ${isDarkMode ? "text-white" : "text-gray-900"}`}>
                  Total:{" "}
                  {formatCurrency(
                    parseFloat(confirmAction.period.totalAmount || confirmAction.period.total_amount || 0)
                  )}
                </p>
              </div>
            </div>
