  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className={`text-xl font-semibold ${isDarkMode ? "text-white" : "text-gray-900"}`}>Commission History</h2>
          {salesPersonName && (
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-xl font-bold text-yellow-500`}>{formatCurrency(summary.totalPending)}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-xl font-bold text-blue-500`}>{formatCurrency(summary.totalApproved)}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-xl font-bold text-green-500`}>{formatCurrency(summary.totalPaid)}</p>
            </div>
      ...
      >
        {loading ? (
          <div className="flex items-center justify-center py-12">
            ...
            <span className={`ml-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Loading history...</span>
          </div>
        ) : error ? (
                  ...
                  {commissions.map((commission, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className={`px-4 py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>{rate}%</td>
