...
describe("WarehouseFormDialog", () => {
  ...
  describe("Rendering", () => {
    it("should render warehouse form dialog", () => {
      const { container } = renderWithProviders(
        <WarehouseFormDialog {...defaultProps} />,
      );
    ...
    it("should hide dialog when not open", () => {
      const { container } = renderWithProviders(
        <WarehouseFormDialog {...defaultProps} isOpen={false} />,
      );
      expect(container).toBeInTheDocument();
    });
  });
  ...
  describe("Edit Mode", () => {
    it("should load warehouse data for editing", () => {
      ...
      const { container } = renderWithProviders(
        <WarehouseFormDialog {...defaultProps} warehouseId="WH-001" />,
      );
      expect(container).toBeInTheDocument();
    });
  ...
  describe("Error Handling", () => {
    it("should handle creation errors", () => {
      mockWarehouseService.createWarehouse.mockRejectedValue(
        new Error("API Error"),
      );
      const { container } = renderWithProviders(
        <WarehouseFormDialog {...defaultProps} />,
    ...
    it("should handle update errors", () => {
      mockWarehouseService.updateWarehouse.mockRejectedValue(
        new Error("API Error"),
      );
      const { container } = renderWithProviders(
        <WarehouseFormDialog {...defaultProps} warehouseId="WH-001" />,
    ...
    it("should handle loading errors", () => {
      mockWarehouseService.getWarehouse.mockRejectedValue(
