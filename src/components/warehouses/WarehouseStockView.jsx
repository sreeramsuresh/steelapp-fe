        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <select
            ...
            className={`px-4 py-2 rounded-lg border ${
              isDarkMode ? "bg-[#121418] border-gray-600 text-white" : "bg-white border-gray-300 text-gray-900"
            } focus:outline-none focus:ring-2 focus:ring-teal-500`}
          >
                  ...
                  >
                    <td className="px-4 py-3">
                      <div>
                        ...
                        <p className={`text-xs ${isDarkMode ? "text-gray-500" : "text-gray-500"}`}>{item.productSku}</p>
                      </div>
                    </td>
                    <td className="px-4 py-3">
                      <span
