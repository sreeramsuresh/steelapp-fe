      ...
      <div className={`px-4 py-3 border-b ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}>
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3 min-w-0">
            <div className={`p-2 rounded-lg shrink-0 ${isDarkMode ? "bg-teal-900/30" : "bg-teal-100"}`}>
      ...
      <div className="px-4 py-3 space-y-3">
        ...
        {contactPerson && (
          <div className="flex items-center gap-2">
            ...
            <span className={`text-sm ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>{contactPerson}</span>
          </div>
        )}
        ...
        {capacity > 0 && (
          <div className="space-y-1">
            <div className="flex items-center justify-between">
              ...
              <span className={`text-xs font-medium min-w-fit ${getUtilizationColor(utilizationPercent)}`}>
                {utilizationPercent}%
              </span>
            </div>
