...
const mockReverseChargeData = {
  summary: {
    ...
    totalValue: 425000.0,
    totalVAT: 21250.0, // 5% of total value
    outputVAT: 21250.0, // Self-accounted output VAT
  ...
  form201Mapping: {
    box9: 21250.0, // Supplies subject to reverse charge (input)
    box7Contribution: 21250.0, // Contributes to total output VAT
  },
};
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className={`flex rounded-lg p-0.5 ${isDarkMode ? "bg-[#2E3B4E]" : "bg-gray-100"}`}>
          ...
          <button type="button" onClick={() => setSelectedView("transactions")}
            className={`px-2 py-1 text-xs rounded-md transition-colors ${
      ...
      <div className="mt-4 flex gap-2">
        {onAddReverseCharge && (
          <button type="button" onClick={onAddReverseCharge}
