...
const DESIGNATED_ZONES = [
  ...
  { code: 'SAIF', name: 'Sharjah Airport International Free Zone', emirate: 'Sharjah' },
    ...
    <div className={`rounded-xl border p-4 sm:p-5 transition-all duration-300 hover:shadow-lg ${
                    ...
                    <div className="text-right">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className={`text-xs ${
                          tx.status === 'compliant' ? 'text-green-500' : 'text-yellow-500'
                        }`}>
            ...
            >
              ...
              <div className="flex items-center justify-between text-xs">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {zone.pending > 0 && (
                    <span className="text-yellow-500">{zone.pending} pending</span>
                  )}
                </div>
              </div>
            </div>
      ...
      <div className={`mt-4 pt-3 border-t ${isDarkMode ? 'border-[#37474F]' : 'border-gray-200'}`}>
        ...
        <div className="flex flex-wrap gap-1">
          {zoneData.documentChecklist.filter(d => d.required).map((doc, idx) => (
            <span
              key={idx}
