        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className={`text-xs ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>Quarterly Filing Status</p>
            </div>
          </div>
        </div>
        <div
  ...
  return (
    ...
    >
        ...
        {returnData.quarters.map((quarter) => {
          ...
          return (
            ...
            >
              ...
              <p className={`text-xs mb-1 ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>{quarter.period}</p>
              <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1">
              ...
              <span className={isDarkMode ? "text-gray-400" : "text-gray-500"}>
                {returnData.quarters.filter((q) => q.status === "submitted").length} Submitted
              </span>
            </div>
            <div className="flex items-center gap-1">
              <div className="w-2 h-2 rounded-full bg-gray-400" />
              <span className={isDarkMode ? "text-gray-400" : "text-gray-500"}>
                {returnData.quarters.filter((q) => q.status === "draft").length} Draft
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="mt-4 flex gap-2">
        {onGenerateReturn && (
          <button type="button" onClick={onGenerateReturn}
        ...
        <button type="button" onClick={() => window.open("https://tax.gov.ae", "_blank")}
