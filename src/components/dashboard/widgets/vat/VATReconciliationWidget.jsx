...
const VATReconciliationWidget = ({
  ...
  const hasData =
    reconciliationData &&
    reconciliationData.salesReconciliation &&
    reconciliationData.purchaseReconciliation;
  ...
  const salesStatus = getStatusConfig(
    reconciliationData.salesReconciliation.status,
  );
  const purchaseStatus = getStatusConfig(
    reconciliationData.purchaseReconciliation.status,
  );
  const SalesIcon = salesStatus.icon;
  const PurchaseIcon = purchaseStatus.icon;

  const pendingDiscrepancies = reconciliationData.discrepancies.filter(
    (d) => d.status === 'pending',
  );
        ...
        <>
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <span
                  className={`text-xs font-medium ${salesStatus.textColor}`}
                >
                  {salesStatus.label}
                </span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div>
                ...
                >
                  {formatCurrency(
                    reconciliationData.salesReconciliation.salesRegisterTotal,
                  )}
                </p>
              </div>
              <div>
                ...
                >
                  {formatCurrency(
                    reconciliationData.salesReconciliation.vatCollected,
                  )}
                </p>
              </div>
            </div>
            ...
            >
              ...
              {reconciliationData.salesReconciliation.invoiceCount} invoices
              matched
            </div>
          </div>
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <span
                  className={`text-xs font-medium ${purchaseStatus.textColor}`}
                >
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              ...
              <div>
                ...
                >
                  {formatCurrency(
                    reconciliationData.purchaseReconciliation.vatPaid,
                  )}
                </p>
              </div>
            </div>
            ...
            >
              ...
              {reconciliationData.purchaseReconciliation.billCount} bills
              matched
            </div>
          </div>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              >
                {formatCurrency(
                  reconciliationData.vatReturnReconciliation.netVATPayable,
                )}
              </span>
            </div>
          </div>
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1">
            ...
            >
              Last reconciled:{' '}
              {formatLastReconciled(reconciliationData.lastReconciled)}
            </span>
          </div>
          {onViewDetails && (
            <button
