        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className={`text-xs ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>Register Matching</p>
            </div>
          </div>
        </div>
        <div
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {onRunReconciliation && (
          <button type="button" onClick={onRunReconciliation}
            disabled={isLoading}
      ...
      <div className={`flex rounded-lg p-0.5 mb-4 ${isDarkMode ? "bg-[#2E3B4E]" : "bg-gray-100"}`}>
        ...
        <button type="button" onClick={() => setSelectedTab("discrepancies")}
      ...
      {selectedTab === "overview" && (
        <>
          ...
          <div className={`p-3 rounded-lg border mb-3 ${salesStatus.bgColor} ${salesStatus.borderColor}`}>
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className={`text-xs font-medium ${salesStatus.textColor}`}>{salesStatus.label}</span>
              </div>
            </div>
            ...
            <div className={`mt-2 text-xs ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>
              {reconciliationData.salesReconciliation.matchedInvoices}/
              {reconciliationData.salesReconciliation.invoiceCount} invoices matched
            </div>
          </div>

          {/* Purchase Reconciliation */}
          <div className={`p-3 rounded-lg border mb-3 ${purchaseStatus.bgColor} ${purchaseStatus.borderColor}`}>
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className={`text-xs font-medium ${purchaseStatus.textColor}`}>{purchaseStatus.label}</span>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div>
            ...
            <div className={`mt-2 text-xs ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>
              {reconciliationData.purchaseReconciliation.matchedBills}/
              {reconciliationData.purchaseReconciliation.billCount} bills matched
            </div>
          </div>
        ...
        <div className="space-y-2 max-h-56 overflow-y-auto">
          {pendingDiscrepancies.length > 0 ? (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right ml-2">
                    <p className={`text-sm font-bold ${disc.variance > 0 ? "text-red-500" : "text-green-500"}`}>
                      {disc.variance > 0 ? "+" : ""}
                      {formatCurrency(disc.variance)}
                    </p>
            ...
            <div className={`p-6 text-center rounded-lg ${isDarkMode ? "bg-[#2E3B4E]" : "bg-gray-50"}`}>
              ...
              <p className={`text-sm font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}>No Discrepancies</p>
              <p className={`text-xs ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>All records are reconciled</p>
            </div>
          )}
        </div>
      )}
