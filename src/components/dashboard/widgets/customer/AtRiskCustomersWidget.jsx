    ...
    return (
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className={`text-lg font-semibold ${isDarkMode ? "text-white" : "text-gray-900"}`}>At-Risk Customers</h3>
        </div>
        <div className="text-center py-8">
          ...
          />
          <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>No at-risk data available</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className={`text-xs ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>Churn Prevention</p>
          </div>
        </div>
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <p className={`text-xs ${isDarkMode ? "text-red-400/70" : "text-red-600"}`}>revenue at risk</p>
          </div>
        </div>
      </div>
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  {/* Risk Score */}
                  <div
                    className={`w-10 h-10 rounded-full ${getRiskScoreColor(customer.riskScore)} flex items-center justify-center`}
                  >
                  ...
                  {/* Stats */}
                  <div className="text-right">
                    <p className={`text-sm font-bold ${riskStyle.text}`}>{customer.daysSinceOrder}d</p>
                    <p className={`text-xs ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>since order</p>
                  </div>
                ...
                <div className={`px-3 pb-3 border-t ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}>
                  <div className="pt-3 space-y-2">
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      <div>
                        <span className={isDarkMode ? "text-gray-400" : "text-gray-500"}>Revenue at Risk:</span>
                        <span className={`ml-1 font-medium ${riskStyle.text}`}>
                          {formatCurrency(customer.revenueAtRisk)}
                        </span>
                      </div>
                      <div>
                        <span className={isDarkMode ? "text-gray-400" : "text-gray-500"}>Decline:</span>
                        <span className={`ml-1 font-medium ${riskStyle.text}`}>{customer.declinePercent}%</span>
                      </div>
                    </div>

                    <div className={`p-2 rounded ${isDarkMode ? "bg-gray-800" : "bg-white"}`}>
                      <p className={`text-xs ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>Recommended Action:</p>
