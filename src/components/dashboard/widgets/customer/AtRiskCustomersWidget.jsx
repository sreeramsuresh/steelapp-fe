        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              >
                {summary.highRisk} high | {summary.mediumRisk} medium |{' '}
                {summary.lowRisk} low
              </p>
            </div>
          </div>
        ...
        {customers.slice(0, 4).map((customer) => {
          ...
          return (
            ...
            >
              ...
              {isExpanded && (
                <div
                  className={`px-3 pb-3 border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}
                >
                  <div className="pt-3 space-y-2">
                    ...
                    <div
                      className={`p-2 rounded ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}
                    >
                      <p
                        className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}
                      >
