...
const MOCK_NEW_CUSTOMER_DATA = {
  ...
  acquisitionSources: [
    { source: 'Referral', count: 5, value: 1250000, percent: 42, icon: Handshake, color: '#22C55E' },
    { source: 'Cold Outreach', count: 4, value: 980000, percent: 33, icon: Megaphone, color: '#3B82F6' },
    { source: 'Exhibition', count: 2, value: 450000, percent: 17, icon: Building2, color: '#F59E0B' },
    { source: 'Website', count: 1, value: 170000, percent: 8, icon: Target, color: '#8B5CF6' },
  ],
  recentCustomers: [
    {
      id: 1,
...
const NewCustomerWidget = ({
  ...
  const growthPercent = ((summary.newCustomersCount - summary.previousPeriodCount) / summary.previousPeriodCount * 100).toFixed(1);
