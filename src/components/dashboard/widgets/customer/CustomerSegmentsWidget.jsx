...
const MOCK_SEGMENTS_DATA = {
  byIndustry: [
    { name: 'Fabricators', count: 58, revenue: 12500000, percent: 37, color: '#14B8A6' },
    { name: 'Traders', count: 42, revenue: 8900000, percent: 27, color: '#3B82F6' },
    { name: 'OEMs', count: 28, revenue: 7200000, percent: 18, color: '#F59E0B' },
    { name: 'Projects', count: 18, revenue: 4800000, percent: 12, color: '#8B5CF6' },
    { name: 'Others', count: 10, revenue: 1600000, percent: 6, color: '#6B7280' },
  ],
  bySize: [
    { name: 'Enterprise', count: 25, revenue: 15200000, percent: 16, color: '#22C55E' },
    { name: 'SMB', count: 68, revenue: 12800000, percent: 44, color: '#3B82F6' },
    { name: 'Small', count: 63, revenue: 7000000, percent: 40, color: '#F59E0B' },
  ],
  byGeography: [
    { name: 'Dubai', count: 65, revenue: 14500000, percent: 42, color: '#14B8A6' },
    { name: 'Abu Dhabi', count: 38, revenue: 8200000, percent: 24, color: '#3B82F6' },
    { name: 'Sharjah', count: 28, revenue: 5800000, percent: 18, color: '#F59E0B' },
    { name: 'RAK', count: 15, revenue: 3200000, percent: 10, color: '#8B5CF6' },
    { name: 'Others', count: 10, revenue: 2300000, percent: 6, color: '#6B7280' },
  ],
  totalCustomers: 156,
    ...
    return (
      <div className={`rounded-xl border p-6 ${
        ...
        <div className="text-center py-8">
          <PieChart size={48} className={`mx-auto mb-4 opacity-50 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`} />
