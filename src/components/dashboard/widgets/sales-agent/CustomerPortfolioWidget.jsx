...
const MOCK_PORTFOLIO_DATA = {
  ...
  segments: [
    { name: 'Fabricators', count: 18, revenue: 2800000, percent: 40, color: '#14B8A6' },
    { name: 'Traders', count: 12, revenue: 1750000, percent: 25, color: '#3B82F6' },
    { name: 'OEMs', count: 8, revenue: 1400000, percent: 20, color: '#F59E0B' },
    { name: 'Projects', count: 10, revenue: 1050000, percent: 15, color: '#8B5CF6' },
  ],
  trendData: {
    newThisMonth: 3,
    churnedThisMonth: 1,
