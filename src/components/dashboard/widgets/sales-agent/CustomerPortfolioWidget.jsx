      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="text-center">
            ...
            <p
              className={`text-lg font-bold ${getDiversificationColor(summary.diversificationScore)}`}
            >
          ...
          <div className="text-right">
            ...
            <span
              className={`px-2 py-1 rounded text-xs font-medium ${riskStyle.bg} ${riskStyle.text}`}
            >
              {summary.riskLevel}
            </span>
          </div>
            ...
            <svg className="w-16 h-16 transform -rotate-90">
              {
                segments.reduce(
                  (acc, segment, idx) => {
                    ...
                    const startX =
                      32 + 24 * Math.cos((startAngle * Math.PI) / 180);
                    const startY =
                      32 + 24 * Math.sin((startAngle * Math.PI) / 180);
