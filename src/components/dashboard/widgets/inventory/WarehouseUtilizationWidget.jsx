  ...
  useEffect(() => {
    ...
    if (data && data.warehouses && data.warehouses.length > 0) {
      ...
      const correctedData = {
        ...
        summary: {
          ...data.summary,
          avgUtilization: data.summary && data.summary.totalCapacity > 0
        ...
        {warehouseData.warehouses.map((warehouse) => {
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between mb-2">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`text-[10px] px-1.5 py-0.5 rounded ${status.bgLight} ${status.color}`}
                    >
                      {status.label}
                    </span>
                  </div>
              ...
              {/* Progress Bar */}
              <div
                className={`h-2 rounded-full overflow-hidden ${isDarkMode ? 'bg-[#121418]' : 'bg-gray-100'}`}
              >
                <div
