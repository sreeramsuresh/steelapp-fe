...
const StockTurnoverWidget = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="text-right">
            ...
            <p
              className={`text-lg font-bold ${getEfficiencyColor(turnoverData.overallEfficiency)}`}
            >
      ...
      {hoveredCell && (
        <div
          className={`mt-2 p-2 rounded-lg text-xs ${isDarkMode ? 'bg-[#121418]' : 'bg-gray-100'}`}
        >
      ...
      >
        ...
        <div>
          ...
          <p
            className={`text-xs font-medium text-green-500 truncate`}
            title={turnoverData.bestPerformer}
          >
        ...
        <div>
          ...
          <p
            className={`text-xs font-medium text-red-500 truncate`}
            title={turnoverData.worstPerformer}
          >
