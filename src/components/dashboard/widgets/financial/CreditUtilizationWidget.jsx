 ...
 */
export const CreditUtilizationWidget = ({ creditUtilization, loading = false, onRefresh }) => {
  ...
  return (
    <BaseWidget
      ...
      size="sm"
    >
      <MetricValue value={`${displayUtilization.toFixed(1)}%`} label="Outstanding vs credit limits" size="md" />
      {/* Progress bar */}
      <div className="mt-3">
