import { Calendar, Layers, TrendingDown, TrendingUp } from "lucide-react";
...
const CategoryPerformanceWidget = ({ data, onNavigate: _onNavigate, onCategoryClick }) => {
  ...
  return (
    ...
    >
      ...
      {/* Summary Footer */}
      <div
        className={`mt-4 pt-3 border-t grid grid-cols-3 gap-4 ${isDarkMode ? "border-[#37474F]" : "border-gray-200"}`}
      >
