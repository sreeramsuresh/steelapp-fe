...
describe('BaseWidget', () => {
  describe('Loading State', () => {
    it('renders skeleton when loading', () => {
      renderWithTheme(
        <BaseWidget title="Test" loading={true}>
          <div>Content</div>
        </BaseWidget>,
      );
  ...
  describe('Error State', () => {
    it('renders error message when error prop provided', () => {
      renderWithTheme(
        <BaseWidget title="Test" error="Something went wrong">
          <div>Content</div>
        </BaseWidget>,
      );
  ...
  describe('Success State', () => {
    ...
    it('renders description when provided', () => {
      renderWithTheme(
        <BaseWidget title="Test" description="Widget description">
          <div>Content</div>
        </BaseWidget>,
      );
    ...
    it('shows refresh button when onRefresh provided', () => {
      renderWithTheme(
        <BaseWidget title="Test" onRefresh={() => {}}>
          <div>Content</div>
        </BaseWidget>,
      );
      expect(
...
describe('MetricValue', () => {
  ...
  it('renders positive change indicator', () => {
    renderWithTheme(
      <MetricValue value="100" change={5.5} changeType="positive" />,
    );
  ...
  it('renders negative change indicator', () => {
    renderWithTheme(
      <MetricValue value="100" change={-3.2} changeType="negative" />,
    );
