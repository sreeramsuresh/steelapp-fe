import { BarChart, FunnelChart, GaugeChart, HeatmapChart, TreemapChart } from "echarts/charts";
import {
  GridComponent,
  LegendComponent,
  TitleComponent,
...
export const EChartsWrapper = ({ option, isDarkMode = false, height = 300, showToolbox = false, onEvents, style }) => {
...
export const TreemapChartWrapper = ({
  ...
  return <EChartsWrapper option={option} isDarkMode={isDarkMode} height={height} showToolbox={showToolbox} />;
};
    ...
    tooltip: {
      ...
      formatter:
        ...
        ((params) => {
          ...
          const value = Array.isArray(param.value) ? param.value[1] - param.value[0] : param.value;
...
export const HeatmapChartWrapper = ({
  ...
  const option = {
    ...
    visualMap: {
      ...
      bottom: "0%",
      inRange: {
        color: isDarkMode ? ["#1E3A5F", "#14B8A6", "#F59E0B", "#EF4444"] : ["#E0F2FE", "#14B8A6", "#F59E0B", "#EF4444"],
      },
      textStyle: {
        color: colors.textSecondary,
      },
