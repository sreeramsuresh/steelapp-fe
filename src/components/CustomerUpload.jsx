...
const CustomerUpload = ({ isOpen, onClose, onUploadComplete }) => {
  ...
  const downloadTemplate = async () => {
    try {
      ...
      await downloadFile("/customers/upload/template", "customer_upload_template.csv");
          ...
          <div>
            ...
            {!selectedFile ? (
              ...
              >
                ...
                <p className={`text-sm ${textSecondary}`}>Supports Excel (.xlsx, .xls) and CSV files up to 5MB</p>
                <input
                  ref={fileInputRef}
                  type="file"
                  className="hidden"
