...
const RoleGuideModal = ({ isOpen, onClose }) => {
  ...
  const roles = [
    ...
    },
    {
      ...
      keyAccess: ["Manage all customers", "Approve quotations", "Create and edit invoices", "View sales reports"],
    },
    {
    ...
    },
    {
      ...
      keyAccess: ["Create invoices", "Record payments", "Generate reports", "View customer accounts"],
    },
    {
      ...
      keyAccess: ["Create quotations", "View assigned customers", "Create draft invoices", "Basic customer management"],
    },
  ];
        ...
        <div className="p-6 space-y-8">
          ...
          <section>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className={`text-lg font-bold ${isDarkMode ? "text-white" : "text-gray-900"}`}>Available Roles</h3>
            </div>
          ...
          <section>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>(Avoid these!)</span>
            </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <span
                            className={`text-xs px-2 py-0.5 rounded font-semibold ${
                              combo.risk === "HIGH" ? "bg-red-500 text-white" : "bg-orange-500 text-white"
                            }`}
                          >
                            {combo.risk} RISK
                          </span>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          <div>
                            <div
                              className={`text-xs font-semibold mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}
                            >
                              Combination:
                            </div>
                            {combo.roles.map((role, i) => (
                          ...
                          <div>
                            ...
                            <p className={`text-sm ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>{combo.why}</p>
                          </div>
                        </div>
                        <div className={`mt-3 p-3 rounded ${isDarkMode ? "bg-gray-900/50" : "bg-white"}`}>
                          <div
                            className={`text-xs font-semibold mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}
                          >
                            ⚠️ Potential Impact:
                          </div>
                          <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>{combo.impact}</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <section>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className={`text-lg font-bold ${isDarkMode ? "text-white" : "text-gray-900"}`}>Best Practices</h3>
            </div>
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className={`text-lg font-bold ${isDarkMode ? "text-white" : "text-gray-900"}`}>Multi-Role Example</h3>
            </div>
