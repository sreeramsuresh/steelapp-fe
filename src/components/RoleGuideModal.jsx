  ...
  const roles = [
    {
      ...
      level: "Executive",
      description:
        "Full system access with ability to grant any permission to anyone",
    ...
    },
    {
      ...
      description:
        "Manages all financial operations including invoices, payments, and credit notes",
    ...
    },
    {
      ...
      level: "Department Head",
      description:
        "Manages inventory, stock movements, and delivery operations",
  ...
  const safeCombinations = [
    {
      ...
      benefit:
        "One person can handle both customer orders and delivery coordination",
      icon: CheckCircle,
      color: "text-green-500",
    },
    {
  ...
  const bestPractices = [
    {
      ...
      description:
        "Use the 10 built-in roles for 90% of cases. Only create custom roles for unique needs.",
      icon: Shield,
    },
    {
      title: "Temporary Access for Special Cases",
      description:
        "Instead of permanently changing roles, use temporary permissions with expiration dates.",
      icon: Clock,
    },
    {
      title: "Review Regularly",
      description:
        "Check user roles every quarter. Remove access that is no longer needed.",
      icon: Users,
    },
    {
      title: "Document Permission Grants",
      description:
        "Always provide a clear reason when granting custom permissions.",
      icon: FileText,
    },
    {
      title: "Use Audit Logs",
      description:
        "Monitor the audit trail to detect unusual permission changes.",
      icon: Database,
    },
  ];
      ...
      >
        ...
        <div className="p-6 space-y-8">
              ...
              {roles.map((role, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`text-xs space-y-1 ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}
                    >
              ...
              {safeCombinations.map((combo, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`text-xs space-y-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}
                    >
                      <div>
                        <strong>Why:</strong> {combo.reason}
                      </div>
                      <div>
                        <strong>Benefit:</strong> {combo.benefit}
                      </div>
                    </div>
                  </div>
                );
          ...
          >
            ...
            >
              <p className="font-semibold">
                Scenario: Ahmed manages both Sales and Warehouse
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div
                    className={`p-3 rounded ${isDarkMode ? "bg-gray-800" : "bg-white"}`}
                  >
                ...
                <div>
                  ...
                  <div
                    className={`p-3 rounded text-sm ${isDarkMode ? "bg-gray-800" : "bg-white"}`}
                  >
          ...
          >
            ...
            >
              <p className="font-semibold">
                Scenario: Give accountant temporary access to void invoices for
                year-end
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
