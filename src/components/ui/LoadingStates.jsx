 ...
 * Pulsing dots loader
 */
export const PulsingDots = ({ size = "md", color = "teal", className = "" }) => {
  const sizes = {
    sm: "w-1.5 h-1.5",
    md: "w-2 h-2",
    lg: "w-3 h-3",
...
export const SavingIndicator = ({ status = "idle", lastSaved = null, isDarkMode = false, className = "" }) => {
  const configs = {
    ...
    saved: {
      icon: (
        <svg aria-label="icon" className="w-3 h-3 text-green-500" fill="currentColor" viewBox="0 0 20 20">
          <title>Icon</title>
          <path
            fillRule="evenodd"
    ...
    error: {
      icon: (
        <svg aria-label="icon" className="w-3 h-3 text-red-500" fill="currentColor" viewBox="0 0 20 20">
          <title>Icon</title>
          <path
            fillRule="evenodd"
