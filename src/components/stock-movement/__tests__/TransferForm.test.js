...
describe("TransferForm", () => {
  ...
  describe("Form Submission", () => {
    ...
    it("should disable submit button while loading", () => {
      mockStockMovementService.createTransfer.mockImplementation(
        () => new Promise(() => {}),
      );
      const { container } = renderWithProviders(
        <TransferForm {...defaultProps} />,
    ...
    it("should handle submission errors", () => {
      mockStockMovementService.createTransfer.mockRejectedValue(
        new Error("API Error"),
      );
      const { container } = renderWithProviders(
        <TransferForm {...defaultProps} />,
  ...
  describe("Edge Cases", () => {
    it("should handle single warehouse", () => {
      mockStockMovementService.listWarehouses.mockResolvedValue([
        mockWarehouses[0],
      ]);
      const { container } = renderWithProviders(
        <TransferForm {...defaultProps} />,
    ...
    it("should handle warehouse loading error", () => {
      mockStockMovementService.listWarehouses.mockRejectedValue(
