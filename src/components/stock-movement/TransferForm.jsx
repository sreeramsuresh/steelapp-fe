...
const TransferForm = ({ onCancel, onSuccess }) => {
  ...
  const validateForm = () => {
    ...
    for (const item of items) {
      ...
      if (qty > available) {
        setError(`Insufficient stock for ${item.product?.name || 'product'}. Available: ${formatQuantity(available, item.unit)}`);
        return false;
      }
    }
            ...
            <Table size="small">
              <TableHead>
                <TableRow sx={{ backgroundColor: 'grey.50' }}>
                  ...
                  <TableCell align="right" sx={{ width: 150 }}>Quantity</TableCell>
                    ...
                    <TableRow key={item.id}>
                      <TableCell>
                        <Autocomplete
                          ...
                          value={item.product}
                          onChange={(e, newValue) => handleItemChange(item.id, 'product', newValue)}
                          renderInput={(params) => (
                      ...
                      <TableCell align="right">
                        <TextField
                          ...
                          sx={{ width: 120 }}
                          error={item.productId && parseFloat(item.quantity) > available}
                        />
                      </TableCell>
                      <TableCell>
