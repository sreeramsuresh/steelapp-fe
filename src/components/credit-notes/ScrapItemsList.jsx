          ...
          <table className="w-full">
            <thead>
              <tr className={isDarkMode ? 'text-gray-400' : 'text-gray-600'}>
                ...
                {!creditNoteId && (
                  <th className="text-left py-2 px-3 text-sm font-medium">Credit Note</th>
                )}
            ...
            {filteredItems.length > 0 && (
              <tfoot>
                <tr className={`border-t-2 ${isDarkMode ? 'border-gray-600' : 'border-gray-300'}`}>
                  <td colSpan={creditNoteId ? 3 : 4} className={`py-3 px-3 font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                    Total Scrap Value
                  </td>
