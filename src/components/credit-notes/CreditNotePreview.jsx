...
import { formatAddress, formatCurrency, TIMEZONE_DISCLAIMER, toUAEDateProfessional } from "../../utils/invoiceUtils";
...
const CreditNotePreview = ({ creditNote, company, onClose }) => {
  ...
  const totalCredit =
    creditNote.totalCredit || creditNote.total_credit || parseFloat(subtotal) + parseFloat(vatAmount) || 0;
            ...
            <div className={`p-6 ${isDarkMode ? "text-gray-200" : "text-gray-800"}`}>
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  {creditNote.customer?.trn && <p className="text-sm">TRN: {creditNote.customer.trn}</p>}
                </div>
                ...
                <div className="text-right">
                  <div className="space-y-1">
                    ...
                    <p>
                      ...
                      <span className="font-medium">{getStatusLabel(creditNote.status)}</span>
                    </p>
                    <p>
              ...
              <div className={`mb-6 p-4 rounded-lg ${isDarkMode ? "bg-gray-800" : "bg-gray-50"}`}>
                ...
                <p>{creditNote.reasonForReturn || creditNote.reason_for_return || "Not specified"}</p>
              </div>
              ...
              {creditNote.items && creditNote.items.length > 0 ? (
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className={`border-b ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}>
                          ...
                          <th className="py-2 text-center text-sm font-medium">Qty Returned</th>
                        ...
                        {creditNote.items
                          ...
                          .map((item, index) => {
                            ...
                            return (
                              ...
                              >
                                <td className="py-3">
                                  <p className="font-medium">{item.name || item.productName || item.product_name}</p>
                                  {item.description && (
                ...
                <div className={`mb-6 p-4 rounded-lg ${isDarkMode ? "bg-gray-800" : "bg-gray-50"}`}>
                  ...
                  <p className="text-xl font-bold" style={{ color: templateColor }}>
              ...
              <div className="flex justify-end">
                <div className="w-64">
                  ...
                  {(creditNote.restockingFee || creditNote.restocking_fee) > 0 && (
                    <div
                      className={`flex justify-between py-2 border-b ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}
                    >
              ...
              {(creditNote.notes || creditNote.internal_notes) && (
                <div className={`mt-6 p-4 rounded-lg ${isDarkMode ? "bg-gray-800" : "bg-gray-50"}`}>
                  ...
                  <p className="text-sm whitespace-pre-wrap">{creditNote.notes || creditNote.internal_notes}</p>
                </div>
              )}
