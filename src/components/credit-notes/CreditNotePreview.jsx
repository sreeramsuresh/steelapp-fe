  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col`}>
                ...
                <div className="text-right">
                  <div className="space-y-1">
                    ...
                    <p>
                      ...
                      <span className="font-medium">
                        {creditNote.invoiceNumber || creditNote.invoice_number || creditNote.invoice?.invoice_number || 'Not linked'}
                      </span>
                    </p>
                    <p>
        ...
        {!validation.isValid && (
          <div className={`px-6 py-3 border-t ${isDarkMode ? 'bg-yellow-900/20 border-yellow-800' : 'bg-yellow-50 border-yellow-200'}`}>
            <div className="flex items-start gap-2">
              <AlertTriangle className={`h-5 w-5 flex-shrink-0 ${isDarkMode ? 'text-yellow-400' : 'text-yellow-600'}`} />
              <div>
