            ...
            <div className={`p-6 ${isDarkMode ? "text-gray-200" : "text-gray-800"}`}>
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  {customerDetails.company && <p className="text-sm">{customerDetails.company}</p>}
                  {customerAddress.street && <p className="text-sm">{customerAddress.street}</p>}
                ...
                <div className="text-right">
                  <div className="mb-2">
                    ...
                    <span className="font-medium">
                      {toUAEDateProfessional(quotation.quotationDate || quotation.quotation_date)}
                    </span>
                  </div>
                  {(quotation.validUntil || quotation.valid_until) && (
                    <div className="mb-2">
                      ...
                      <span className="font-medium">
                        {toUAEDateProfessional(quotation.validUntil || quotation.valid_until)}
                      </span>
                    </div>
                  )}
                  <div className="mb-2">
                        ...
                        items.map((item, index) => (
                          <tr key={index} className={`border-t ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}>
                            ...
                            <td className="px-4 py-3 text-right font-medium">
                              {formatCurrency(item.netAmount || item.net_amount || item.amount || 0)}
                            </td>
                          </tr>
                        ))
                      ) : (
