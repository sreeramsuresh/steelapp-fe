...
class FormErrorBoundary extends Component {
  ...
  componentDidCatch(error, errorInfo) {
    ...
    console.error(`[Form Error] ${this.props.formName || "Unknown Form"} crashed:`, error, errorInfo);
      ...
      return (
        ...
        >
          ...
          >
            ...
            <h3 className={`text-lg font-semibold mb-2 text-center ${isDarkMode ? "text-white" : "text-gray-900"}`}>
              {formName || "Form"} Error
            </h3>

            <p className={`text-sm text-center mb-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
              An unexpected error occurred while loading this form. We apologize for the inconvenience.
            </p>
