...
const ProtectedRoute = ({
  ...
  if (!user) {
    return (
      <div
        className={`flex items-center justify-center min-h-[60vh] ${isDarkMode ? 'bg-[#121418]' : 'bg-[#FAFAFA]'}`}
      >
    ...
    return (
      ...
      >
        ...
        <p className={`mb-6 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
          ...
          {requiredRoles ? requiredRoles.join(' or ') : requiredRole}) to access
          this page.
        </p>
        <div
        ...
        >
          ...
          <p>
            ...
            {requiredRoles ? requiredRoles.join(' or ') : requiredRole}
          </p>
        </div>
        <button
    ...
    if (!authService.hasPermission(resource, action)) {
      return (
        ...
        >
          ...
          <div
            className={`mb-6 max-w-md p-4 rounded-lg border ${isDarkMode ? 'bg-blue-900/20 border-blue-700 text-blue-300' : 'bg-blue-50 border-blue-200 text-blue-800'}`}
          >
            <p className="mb-2">
