...
const DELETION_REASONS = [
  { value: 'duplicate', label: 'Duplicate Entry', description: 'This invoice was created by mistake (duplicate)' },
  { value: 'error', label: 'Entered in Error', description: 'Wrong data or information was entered' },
  { value: 'cancelled', label: 'Customer Cancellation', description: 'Customer cancelled the order' },
  { value: 'pricing', label: 'Pricing Error', description: 'Incorrect pricing or rates' },
  { value: 'wrong_customer', label: 'Wrong Customer', description: 'Invoice created for wrong customer' },
  { value: 'data_mistake', label: 'Data Entry Mistake', description: 'General data entry error' },
  { value: 'other', label: 'Other Reason', description: 'Specify custom reason below' },
];
      ...
      >
        ...
        <div className="p-6 space-y-4">
          ...
          >
            ...
            <p className="text-xs">
              This invoice will be marked as deleted but retained in the system for audit and compliance purposes.
