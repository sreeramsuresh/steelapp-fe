        ...
        <div className="p-6 space-y-4">
          ...
          >
            <p className="text-sm font-medium mb-1">
              ⚠️ Important: Soft Delete with Audit Trail
            </p>
            <p className="text-xs">
              This invoice will be marked as deleted but retained in the system
              for audit and compliance purposes. You can restore it later if
              needed.
            </p>
          </div>
