...
export default function CustomerActivityTab({ customerId }) {
  ...
  const mockActivities = useMemo(() => [
    ...
    },
    {
      ...
      user: 'Mike Johnson',
      content: 'Customer disputed invoice INV-2024-445 due to quality issue with delivered materials. Investigating with warehouse team.',
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className={`text-xs ${isDarkMode ? 'text-yellow-300' : 'text-yellow-600'} mt-1`}>
              This tab is using mock data. Backend API integration needed at GET /api/activities and POST /api/activities
            </p>
          </div>
        </div>
      </div>
