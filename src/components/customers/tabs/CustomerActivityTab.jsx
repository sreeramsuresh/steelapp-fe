...
export default function CustomerActivityTab({ customerId }) {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-wrap gap-4 items-end">
          ...
          <div className="flex-1 min-w-[200px]">
            ...
            <div className="relative">
              <Search
                size={18}
                className={`absolute left-3 top-1/2 transform -translate-y-1/2 ${mutedText}`}
              />
              <input
                id="activity-search"
                type="text"
      ...
      {/* Activity Timeline */}
      <div className={`${cardBg} border ${borderColor} rounded-lg p-6`}>
        <h3 className={`text-lg font-semibold ${primaryText} mb-6`}>
          Activity Timeline
        </h3>
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          ...
                          <span className={`text-sm ${mutedText} ml-2`}>
                            by {activity.user}
                          </span>
                        </div>
                        <div
                          className={`text-sm ${mutedText} flex items-center gap-1`}
                        >
                          <Calendar size={14} />
                      ...
                      <p className={`text-sm ${primaryText} mb-2`}>
                        {activity.content}
                      </p>
