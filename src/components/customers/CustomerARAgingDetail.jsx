...
import { Clock, CreditCard, TrendingUp, AlertTriangle, RefreshCw } from 'lucide-react';
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <span className={`text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Current (Not Overdue)</span>
              <span className={`text-sm font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{formatCurrency(data.agingCurrent)}</span>
            </div>
            <div className={`w-full h-2 rounded-full overflow-hidden ${isDarkMode ? 'bg-gray-700' : 'bg-gray-200'}`}>
              <div
                className="h-full bg-green-500 rounded-full transition-all duration-500"
                style={{ width: data.totalAr > 0 ? `${((data.agingCurrent || 0) / data.totalAr) * 100}%` : '0%' }}
              />
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <span className={`text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>1-30 Days Overdue</span>
              <span className={`text-sm font-bold ${data.aging1To30 > 0 ? 'text-yellow-600' : isDarkMode ? 'text-white' : 'text-gray-900'}`}>
            ...
            <div className={`w-full h-2 rounded-full overflow-hidden ${isDarkMode ? 'bg-gray-700' : 'bg-gray-200'}`}>
              <div
                ...
                style={{ width: data.totalAr > 0 ? `${((data.aging1To30 || 0) / data.totalAr) * 100}%` : '0%' }}
              />
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <span className={`text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>31-60 Days Overdue</span>
              <span className={`text-sm font-bold ${data.aging31To60 > 0 ? 'text-orange-600' : isDarkMode ? 'text-white' : 'text-gray-900'}`}>
            ...
            <div className={`w-full h-2 rounded-full overflow-hidden ${isDarkMode ? 'bg-gray-700' : 'bg-gray-200'}`}>
              <div
                ...
                style={{ width: data.totalAr > 0 ? `${((data.aging31To60 || 0) / data.totalAr) * 100}%` : '0%' }}
              />
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <span className={`text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>61-90 Days Overdue</span>
              <span className={`text-sm font-bold ${data.aging61To90 > 0 ? 'text-red-500' : isDarkMode ? 'text-white' : 'text-gray-900'}`}>
            ...
            <div className={`w-full h-2 rounded-full overflow-hidden ${isDarkMode ? 'bg-gray-700' : 'bg-gray-200'}`}>
              <div
                ...
                style={{ width: data.totalAr > 0 ? `${((data.aging61To90 || 0) / data.totalAr) * 100}%` : '0%' }}
              />
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <span className={`text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>90+ Days Overdue</span>
              <span className={`text-sm font-bold ${data.aging90Plus > 0 ? 'text-red-700' : isDarkMode ? 'text-white' : 'text-gray-900'}`}>
            ...
            <div className={`w-full h-2 rounded-full overflow-hidden ${isDarkMode ? 'bg-gray-700' : 'bg-gray-200'}`}>
              <div
                ...
                style={{ width: data.totalAr > 0 ? `${((data.aging90Plus || 0) / data.totalAr) * 100}%` : '0%' }}
              />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className={`text-sm font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{formatCurrency(data.creditLimit)}</span>
              </div>
              <div className="flex justify-between">
                <span className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Credit Used</span>
                <span className={`text-sm font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{formatCurrency(data.creditUsed)}</span>
              </div>
              <div className="flex justify-between">
            ...
            <div className="mt-4">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className={`text-xs font-medium ${creditUtilizationPct > 90 ? 'text-red-600' : creditUtilizationPct > 75 ? 'text-yellow-600' : 'text-green-600'}`}>
              ...
              <div className={`w-full h-2 rounded-full overflow-hidden ${isDarkMode ? 'bg-gray-700' : 'bg-gray-200'}`}>
                <div
                  className={`h-full rounded-full transition-all duration-500 ${
                    creditUtilizationPct > 90 ? 'bg-red-600' : creditUtilizationPct > 75 ? 'bg-yellow-500' : 'bg-green-500'
                  }`}
          ...
          <div>
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                <span className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Payment History Score</span>
                <span className={`text-sm font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                  {data.paymentHistoryScore?.toFixed(0) || 'N/A'}
                </span>
              </div>
              <div className="flex justify-between">
                <span className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Credit Utilization %</span>
                <span className={`text-sm font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
