    ...
    <div className={`h-full flex flex-col ${isDarkMode ? "bg-gray-800" : "bg-white"}`}>
      ...
      <div className="flex-1 overflow-y-auto px-5 py-3">
        ...
        >
          <div className="space-y-3">
            <p>
              ...
              role within your organization. Instead of assigning permissions to individual users, you assign roles to
              users, and roles have specific permissions.
            </p>
        ...
        >
          <div className="space-y-3">
            <p>
              System roles are pre-configured roles that come with your ERP system. They cannot be deleted but you can
              customize their descriptions and director status.
            </p>
            <div className="space-y-2">
              <div className={`p-3 rounded-lg ${isDarkMode ? "bg-gray-800" : "bg-gray-50"}`}>
                ...
                <ul className={`text-sm space-y-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>
                  <li>
                    • <strong>Managing Director</strong> - Chief executive with full authority
                  </li>
                  <li>
                    • <strong>Operations Manager</strong> - Oversees daily operations
                  </li>
                  <li>
                    • <strong>Finance Manager</strong> - Financial planning and reporting
                  </li>
                  <li>
                  ...
                  <li>
                    • <strong>Logistics Coordinator</strong> - Shipping coordination
                  </li>
                </ul>
              </div>
            </div>
        ...
        >
          <div className="space-y-3">
            <p>
              Director roles are senior management positions with elevated access across the organization. These roles
              typically have broader permissions and oversight capabilities.
            </p>
            ...
            <p className="text-sm">
              <strong>Note:</strong> You can modify which roles are marked as &quot;Director&quot; roles by editing the
              role in the Manage Roles modal.
            </p>
          </div>
        </HelpSection>
        ...
        >
          <div className="space-y-3">
            ...
            <p className="text-sm">
              <strong>Naming convention:</strong> Use clear, descriptive names like &quot;Regional Sales Manager&quot;
              or &quot;Junior Accountant&quot; to make roles easily identifiable.
            </p>
          </div>
        </HelpSection>
        ...
        >
          <div className="space-y-3">
            ...
            <p className="text-sm">
              <strong>Example:</strong> A user with both &quot;Sales Manager&quot; and &quot;Accounts Manager&quot;
              roles will have access to both sales and accounting features.
            </p>
          </div>
        </HelpSection>
        ...
        >
          <div className="space-y-3">
            <p>
              Permissions define what actions a role can perform in the system. Each role can have different permissions
              for various modules like invoices, customers, products, etc.
            </p>
            <div className="space-y-2">
              <div className={`p-3 rounded-lg ${isDarkMode ? "bg-gray-800" : "bg-gray-50"}`}>
                <h4 className={`font-semibold mb-1 ${isDarkMode ? "text-white" : "text-gray-900"}`}>
            ...
            <p className="text-sm">
              <strong>Permission Inheritance:</strong> Users inherit ALL permissions from ALL their assigned roles. This
              means permissions are additive (union of all role permissions).
            </p>
          </div>
        </HelpSection>
          ...
          <div className="space-y-3">
            <div className={`p-4 rounded-lg ${isDarkMode ? "bg-teal-900/20" : "bg-teal-50"}`}>
              ...
              <ul className={`text-sm space-y-1 ${isDarkMode ? "text-teal-200" : "text-teal-800"}`}>
                <li>
                  • <strong>Principle of Least Privilege:</strong> Grant users only the minimum permissions needed
                </li>
                <li>
                  • <strong>Regular Audits:</strong> Review user roles and permissions quarterly
                </li>
                <li>
                  • <strong>Separation of Duties:</strong> Avoid giving conflicting permissions to single roles
                </li>
                <li>
                  • <strong>Use System Roles:</strong> Start with system roles before creating custom ones
                </li>
                <li>
                  • <strong>Document Changes:</strong> Keep track of role modifications and reasons
                </li>
              </ul>
            </div>
