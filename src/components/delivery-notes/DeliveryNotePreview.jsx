        ...
        <div className="flex-1 overflow-y-auto p-6" style={{ background: isDarkMode ? '#1a1a2e' : '#f5f5f5' }}>
          ...
          <div className={`max-w-3xl mx-auto ${isDarkMode ? 'bg-gray-900' : 'bg-white'} shadow-lg rounded-lg overflow-hidden`}>
            ...
            <div className={`p-6 ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`}>
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  {(deliveryAddress.city || deliveryAddress.poBox) && (
                    <p className="text-sm">
                      {[deliveryAddress.city, deliveryAddress.poBox && `P.O. Box ${deliveryAddress.poBox}`].filter(Boolean).join(', ')}
                    </p>
                  )}
                </div>
                <div className="text-right">
              ...
              {/* Transport Details */}
              {(deliveryNote.vehicleNumber || deliveryNote.vehicle_number || deliveryNote.driverName || deliveryNote.driver_name) && (
                <div className={`mb-6 p-4 rounded-lg ${isDarkMode ? 'bg-gray-800' : 'bg-gray-50'}`}>
                  ...
                  <div className="grid grid-cols-3 gap-4 text-sm">
                    <div>
                      ...
                      <span className="font-medium">{deliveryNote.vehicleNumber || deliveryNote.vehicle_number || '-'}</span>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <span className="font-medium">{deliveryNote.driverPhone || deliveryNote.driver_phone || '-'}</span>
                    </div>
                  </div>
                </div>
              )}
