...
const SteelProducts = () => {
  ...
  const handleCopyFromProduct = (product) => {
    ...
    notificationService.success(`Copied product details from: ${product.displayName || product.display_name || product.uniqueName || 'product'}`);
  };
  ...
  const filteredProducts = products.filter(product => {
    ...
    const matchesSearch = displayName.includes(needle) ||
