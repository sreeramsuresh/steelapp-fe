          ...
          <div className={`rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto ${cardClasses}`}>
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="customerTradeLicenseExpiry" className={`block text-sm font-medium mb-1 ${textSecondary}`}>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className={`rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto ${cardClasses}`}>
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="newSupplierName" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Name</label>
                <input type="text" id="newSupplierName" value={newSupplier.name} onChange={(e)=>setNewSupplier({...newSupplier, name:e.target.value})} className={inputClasses} />
              </div>
              <div>
                <label htmlFor="newSupplierCompany" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Company</label>
                <input type="text" id="newSupplierCompany" value={newSupplier.company} onChange={(e)=>setNewSupplier({...newSupplier, company:e.target.value})} className={inputClasses} />
              </div>
              <div>
                <label htmlFor="newSupplierEmail" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Email</label>
                <input type="email" id="newSupplierEmail" value={newSupplier.email} onChange={(e)=>setNewSupplier({...newSupplier, email:e.target.value})} className={inputClasses} />
              </div>
              <div>
                <label htmlFor="newSupplierPhone" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Phone</label>
                <input type="tel" id="newSupplierPhone" value={newSupplier.phone} onChange={(e)=>setNewSupplier({...newSupplier, phone:e.target.value})} className={inputClasses} />
              </div>
              <div className="md:col-span-2">
                <label htmlFor="newSupplierAddress" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Address</label>
                <input type="text" id="newSupplierAddress" value={newSupplier.address} onChange={(e)=>setNewSupplier({...newSupplier, address:e.target.value})} className={inputClasses} />
              </div>
              <div>
                <label htmlFor="newSupplierTRN" className={`block text-sm font-medium mb-1 ${textSecondary}`}>TRN Number</label>
                <input type="text" id="newSupplierTRN" inputMode="numeric" pattern="\\d*" maxLength={15} placeholder="100XXXXXXXXXXXX" value={newSupplier.trnNumber} onChange={(e)=>setNewSupplier({...newSupplier, trn_number: e.target.value.replace(/\D/g,'').slice(0,15)})} className={inputClasses} />
              ...
              <div>
                <label htmlFor="newSupplierPaymentTerms" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Payment Terms</label>
                <input type="text" id="newSupplierPaymentTerms" placeholder="e.g., Net 30" value={newSupplier.paymentTerms} onChange={(e)=>setNewSupplier({...newSupplier, payment_terms:e.target.value})} className={inputClasses} />
              </div>
              <div>
                <label htmlFor="newSupplierCurrency" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Default Currency</label>
                <select id="newSupplierCurrency" value={newSupplier.defaultCurrency} onChange={(e)=>setNewSupplier({...newSupplier, default_currency:e.target.value})} className={inputClasses}>
              ...
              <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label htmlFor="newSupplierContactName" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Contact Name</label>
                  <input type="text" id="newSupplierContactName" value={newSupplier.contactName} onChange={(e)=>setNewSupplier({...newSupplier, contact_name:e.target.value})} className={inputClasses} />
                </div>
                <div>
                  <label htmlFor="newSupplierContactEmail" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Contact Email</label>
                  <input type="email" id="newSupplierContactEmail" value={newSupplier.contactEmail} onChange={(e)=>setNewSupplier({...newSupplier, contact_email:e.target.value})} className={inputClasses} />
                </div>
                <div>
                  <label htmlFor="newSupplierContactPhone" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Contact Phone</label>
                  <input type="tel" id="newSupplierContactPhone" value={newSupplier.contactPhone} onChange={(e)=>setNewSupplier({...newSupplier, contact_phone:e.target.value})} className={inputClasses} />
                </div>
              </div>
              <div>
                <label htmlFor="newSupplierStatus" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Status</label>
                <select id="newSupplierStatus" value={newSupplier.status} onChange={(e)=>setNewSupplier({...newSupplier, status:e.target.value})} className={inputClasses}>
                  <option value="active">Active</option>
                  <option value="inactive">Inactive</option>
                </select>
              </div>
      ...
      {showEditSupplierModal && selectedSupplier && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className={`rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto ${cardClasses}`}>
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="editSupplierName" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Name</label>
                <input type="text" id="editSupplierName" value={selectedSupplier.name} onChange={(e)=>setSelectedSupplier({...selectedSupplier, name:e.target.value})} className={inputClasses} />
              </div>
              <div>
                <label htmlFor="editSupplierCompany" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Company</label>
                <input type="text" id="editSupplierCompany" value={selectedSupplier.company || ''} onChange={(e)=>setSelectedSupplier({...selectedSupplier, company:e.target.value})} className={inputClasses} />
              </div>
              <div>
                <label htmlFor="editSupplierEmail" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Email</label>
                <input type="email" id="editSupplierEmail" value={selectedSupplier.email || ''} onChange={(e)=>setSelectedSupplier({...selectedSupplier, email:e.target.value})} className={inputClasses} />
              </div>
              <div>
                <label htmlFor="editSupplierPhone" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Phone</label>
                <input type="tel" id="editSupplierPhone" value={selectedSupplier.phone || ''} onChange={(e)=>setSelectedSupplier({...selectedSupplier, phone:e.target.value})} className={inputClasses} />
              </div>
              <div className="md:col-span-2">
                <label htmlFor="editSupplierAddress" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Address</label>
                <input type="text" id="editSupplierAddress" value={selectedSupplier.address || ''} onChange={(e)=>setSelectedSupplier({...selectedSupplier, address:e.target.value})} className={inputClasses} />
              </div>
              <div>
                <label htmlFor="editSupplierTRN" className={`block text-sm font-medium mb-1 ${textSecondary}`}>TRN Number</label>
                <input type="text" id="editSupplierTRN" inputMode="numeric" pattern="\\d*" maxLength={15} placeholder="100XXXXXXXXXXXX" value={selectedSupplier.trnNumber || ''} onChange={(e)=>setSelectedSupplier({...selectedSupplier, trn_number: e.target.value.replace(/\D/g,'').slice(0,15)})} className={inputClasses} />
              ...
              <div>
                <label htmlFor="editSupplierPaymentTerms" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Payment Terms</label>
                <input type="text" id="editSupplierPaymentTerms" placeholder="e.g., Net 30" value={selectedSupplier.paymentTerms || ''} onChange={(e)=>setSelectedSupplier({...selectedSupplier, payment_terms:e.target.value})} className={inputClasses} />
              </div>
              <div>
                <label htmlFor="editSupplierCurrency" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Default Currency</label>
                <select id="editSupplierCurrency" value={selectedSupplier.defaultCurrency || 'AED'} onChange={(e)=>setSelectedSupplier({...selectedSupplier, default_currency:e.target.value})} className={inputClasses}>
                  <option value="AED">AED</option>
                  <option value="USD">USD</option>
                  <option value="INR">INR</option>
                  <option value="EUR">EUR</option>
              ...
              <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label htmlFor="editSupplierContactName" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Contact Name</label>
                  <input type="text" id="editSupplierContactName" value={selectedSupplier.contactName || ''} onChange={(e)=>setSelectedSupplier({...selectedSupplier, contact_name:e.target.value})} className={inputClasses} />
                </div>
                <div>
                  <label htmlFor="editSupplierContactEmail" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Contact Email</label>
                  <input type="email" id="editSupplierContactEmail" value={selectedSupplier.contactEmail || ''} onChange={(e)=>setSelectedSupplier({...selectedSupplier, contact_email:e.target.value})} className={inputClasses} />
                </div>
                <div>
                  <label htmlFor="editSupplierContactPhone" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Contact Phone</label>
                  <input type="tel" id="editSupplierContactPhone" value={selectedSupplier.contactPhone || ''} onChange={(e)=>setSelectedSupplier({...selectedSupplier, contact_phone:e.target.value})} className={inputClasses} />
                </div>
              </div>
              <div>
                <label htmlFor="editSupplierStatus" className={`block text-sm font-medium mb-1 ${textSecondary}`}>Status</label>
                <select id="editSupplierStatus" value={selectedSupplier.status || 'active'} onChange={(e)=>setSelectedSupplier({...selectedSupplier, status:e.target.value})} className={inputClasses}>
                  <option value="active">Active</option>
                  <option value="inactive">Inactive</option>
                </select>
              </div>
          ...
          <div className={`rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto ${cardClasses}`}>
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="editCustomerAlternatePhone" className={`block text-sm font-medium mb-1 ${textSecondary}`}>
                    Alternate Phone
                  </label>
                  <input
                    type="tel"
                ...
                <div className="md:col-span-2">
                  <label htmlFor="editCustomerAddress" className={`block text-sm font-medium mb-1 ${textSecondary}`}>
                    Address
                  </label>
                  <textarea
                    rows={3}
                ...
                <div>
                  <label htmlFor="editCustomerTradeLicense" className={`block text-sm font-medium mb-1 ${textSecondary}`}>
                    Trade License Number
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="editCustomerTradeLicenseExpiry" className={`block text-sm font-medium mb-1 ${textSecondary}`}>
                    Trade License Expiry
                  </label>
                  <input
                    type="date"
                ...
                <div>
                  <label htmlFor="editCustomerCreditLimit" className={`block text-sm font-medium mb-1 ${textSecondary}`}>
                    Credit Limit (د.إ)
                  </label>
                  <input
                    type="number"
                ...
                <div>
                  <label htmlFor="editCustomerCurrentCredit" className={`block text-sm font-medium mb-1 ${textSecondary}`}>
                    Current Credit Used (د.إ)
                  </label>
                  <input
                    type="number"
