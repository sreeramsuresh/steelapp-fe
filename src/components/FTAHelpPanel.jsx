      ...
      <div className="flex-1 overflow-y-auto px-5 py-3">
        ...
        >
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm">
                A Tax Registration Number (TRN) is a unique 15-digit identifier issued by the UAE Federal Tax Authority
                (FTA) to businesses registered for Value Added Tax (VAT). TRN verification confirms that a trading
                partner&apos;s tax registration is valid, active, and matches their business details.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm mb-2">
                Under UAE VAT Law (Federal Decree-Law No. 8 of 2017), every tax invoice must include valid TRN details.
                Invalid or incorrect TRNs can result in:
              </p>
              <ul className="text-sm space-y-1 list-disc list-inside ml-2">
                <li>
                  <strong>Rejected input VAT claims</strong> - FTA may disallow VAT recovery
                </li>
                <li>
                  <strong>Administrative penalties</strong> - Fines of AED 2,500 to AED 20,000
                </li>
                <li>
                  <strong>Audit exposure</strong> - Systematic TRN errors trigger scrutiny
                </li>
                <li>
                  <strong>Business relationship risks</strong> - Trading with unregistered entities
                </li>
              </ul>
            </div>

            <div>
              <h4 className="font-medium mb-2">Benefits of Automatic Verification</h4>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className={`border-t ${isDarkMode ? "border-gray-600" : "border-gray-200"}`}>
                      <td className="px-3 py-2">Visit FTA portal for each check</td>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <ol className="text-sm space-y-2 list-decimal list-inside ml-2">
                <li>
                  ...
                  <br />
                  <span className="ml-5">
                    Visit: <ExtLink href="https://eservices.tax.gov.ae">eservices.tax.gov.ae</ExtLink>
                  </span>
                </li>
                <li>
                ...
                <li>
                  ...
                  <br />
                  <span className="ml-5">Trade License, Authorization letter, Emirates ID</span>
                </li>
                <li>
                  <strong>Review and Approval</strong>
                  <br />
                  <span className="ml-5">FTA reviews within 5-10 business days</span>
                </li>
              </ol>
            </div>
            ...
            <div className={`p-3 rounded-lg ${isDarkMode ? "bg-gray-700" : "bg-blue-50"}`}>
              <div className="flex items-start gap-2">
                <Clock className={`h-4 w-4 mt-0.5 ${isDarkMode ? "text-blue-400" : "text-blue-600"}`} />
          ...
          <div className="space-y-4">
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className={`border-t ${isDarkMode ? "border-gray-600" : "border-gray-200"}`}>
                      ...
                      <td className="px-3 py-2">The FTA API endpoint from your credentials</td>
                    </tr>
                    <tr className={`border-t ${isDarkMode ? "border-gray-600" : "border-gray-200"}`}>
                      <td className="px-3 py-2 font-medium">API Key</td>
                      <td className="px-3 py-2">Your unique authentication key (case-sensitive)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div>
              ...
              <ol className="text-sm space-y-1 list-decimal list-inside ml-2">
                <li>Enter API URL (exactly as provided, no trailing slashes)</li>
            ...
            <div className={`p-3 rounded-lg ${isDarkMode ? "bg-yellow-900/30" : "bg-yellow-50"}`}>
              <div className="flex items-start gap-2">
                <Lock className={`h-4 w-4 mt-0.5 ${isDarkMode ? "text-yellow-400" : "text-yellow-600"}`} />
                <div className="text-sm">
                  <strong>Understanding Soft-Lock</strong>
                  <p className="mt-1">
                    Once saved and tested successfully, settings enter &quot;soft-lock&quot; state. This prevents
                    accidental changes to working credentials. Click &quot;Unlock&quot; to make changes. Only
        ...
        >
          <div className="space-y-4">
            ...
            <div>
              <h4 className="font-medium mb-2">Verification Status Indicators</h4>
            ...
            <div>
              <h4 className="font-medium mb-2">Details Displayed After Verification</h4>
              <ul className="text-sm space-y-1 list-disc list-inside ml-2">
          ...
          <div className="space-y-4">
            <div className={`p-3 rounded-lg ${isDarkMode ? "bg-green-900/30" : "bg-green-50"}`}>
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm">
                  ...
                  <p className="mt-1">
                    Without API access, you still get local format validation and a direct link to FTA&apos;s manual
                    verification portal.
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              <ol className="text-sm space-y-1 list-decimal list-inside ml-2">
                ...
                <li>
                  FTA page opens:{" "}
                  <ExtLink href="https://tax.gov.ae/en/trn.verification.aspx">tax.gov.ae/trn.verification</ExtLink>
                </li>
              ...
              <table className="w-full">
                ...
                <tbody className="text-sm">
                  <tr className={`border-t ${isDarkMode ? "border-gray-600" : "border-gray-200"}`}>
                    ...
                    <td className="px-3 py-2">Re-copy from FTA credentials, check for spaces</td>
                  </tr>
                  <tr className={`border-t ${isDarkMode ? "border-gray-600" : "border-gray-200"}`}>
                    <td className="px-3 py-2 font-medium">Connection Timeout</td>
                    <td className="px-3 py-2">Check internet, try again in few minutes</td>
                  </tr>
                  <tr className={`border-t ${isDarkMode ? "border-gray-600" : "border-gray-200"}`}>
                    <td className="px-3 py-2 font-medium">403 Forbidden</td>
                    <td className="px-3 py-2">Check API status in FTA e-Services</td>
                  </tr>
                  <tr className={`border-t ${isDarkMode ? "border-gray-600" : "border-gray-200"}`}>
                    <td className="px-3 py-2 font-medium">TRN Not Found</td>
                    <td className="px-3 py-2">Verify TRN, allow 24-48h for new registrations</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        >
          <div className="space-y-4">
            <div>
              ...
              <ul className="text-sm space-y-1 list-disc list-inside ml-2">
                <li>
                  <strong>Encryption at Rest:</strong> AES-256 encryption in database
                </li>
                <li>
                  <strong>Encryption in Transit:</strong> TLS 1.2+ for all API communication
                </li>
                <li>
                  <strong>No Client Exposure:</strong> Credentials never sent to browser
                </li>
                <li>
            ...
            <div>
              ...
              <p className="text-sm">
                All activities logged for compliance: configuration changes, connection tests, credential updates,
                lock/unlock actions. Logs retained per UAE requirements (minimum 5 years per Article 78, VAT Executive
                Regulations).
              </p>
            </div>
          </div>
        ...
        >
          <div className="space-y-4">
            <div className={`p-3 rounded-lg ${isDarkMode ? "bg-gray-700" : "bg-gray-50"}`}>
              ...
              <ul className="text-sm space-y-1">
                <li>
                  <ExtLink href="https://eservices.tax.gov.ae">FTA e-Services</ExtLink>
                </li>
                <li>
                  <ExtLink href="https://tax.gov.ae/en/trn.verification.aspx">Manual TRN Verification</ExtLink>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-sm">
                ...
                <code className="px-1 py-0.5 bg-gray-200 dark:bg-gray-600 rounded">100123456789012</code>)
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm space-y-0.5 list-disc list-inside ml-2">
                <li>Tax Invoice Requirements: Article 59, Executive Regulations</li>
