          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm mb-2">
                Under UAE VAT Law (Federal Decree-Law No. 8 of 2017), every tax invoice must
                include valid TRN details. Invalid or incorrect TRNs can result in:
              </p>
              <ul className="text-sm space-y-1 list-disc list-inside ml-2">
                <li><strong>Rejected input VAT claims</strong> - FTA may disallow VAT recovery</li>
                <li><strong>Administrative penalties</strong> - Fines of AED 2,500 to AED 20,000</li>
                <li><strong>Audit exposure</strong> - Systematic TRN errors trigger scrutiny</li>
                <li><strong>Business relationship risks</strong> - Trading with unregistered entities</li>
              </ul>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <ol className="text-sm space-y-1 list-decimal list-inside ml-2">
                ...
                <li>Click <strong>Save</strong> (credentials are encrypted)</li>
        ...
        <HelpSection title="Security & Compliance" icon={Shield}>
          <div className="space-y-4">
            <div>
              ...
              <ul className="text-sm space-y-1 list-disc list-inside ml-2">
                <li><strong>Encryption at Rest:</strong> AES-256 encryption in database</li>
                <li><strong>Encryption in Transit:</strong> TLS 1.2+ for all API communication</li>
                <li><strong>No Client Exposure:</strong> Credentials never sent to browser</li>
                <li><strong>Access Control:</strong> Administrator role only</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-sm">
                All activities logged for compliance: configuration changes, connection tests,
                credential updates, lock/unlock actions. Logs retained per UAE requirements
                (minimum 5 years per Article 78, VAT Executive Regulations).
              </p>
            </div>
          </div>
        </HelpSection>
        ...
        <HelpSection title="Quick Reference" icon={FileText}>
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm">
                15 digits, numeric only (e.g., <code className="px-1 py-0.5 bg-gray-200 dark:bg-gray-600 rounded">100123456789012</code>)
              </p>
            </div>
