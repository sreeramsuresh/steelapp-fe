...
module.exports = {
  meta: {
    ...
    docs: {
      description:
        "Disallow buttons without interaction handlers (dead buttons)",
  ...
  create(context) {
    ...
    return {
      ...
      ImportDeclaration(node) {
        ...
        if (
          node.source.value.includes("ui/button") ||
          node.source.value.includes("@/components/ui/button")
        ) {
